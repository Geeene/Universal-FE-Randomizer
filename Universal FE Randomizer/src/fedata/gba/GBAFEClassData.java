...
public abstract class GBAFEClassData extends AbstractGBAData implements FEPrintableData {
	...
	public GBAStatDAO getAllGrowths() {
		return new GBAStatDAO(getHPGrowth(), getSTRGrowth(), getSKLGrowth(), getSPDGrowth(), getDEFGrowth(), getRESGrowth(), getLCKGrowth());
	}
	...
	public GBAStatDAO getBaseStats() {
		return new GBAStatDAO(getBaseHP(), getBaseSTR(), getBaseSKL(), getBaseSPD(), getBaseDEF(), getBaseRES(), getBaseLCK());
	}
	...
	public GBAStatDAO getMaxStats() {
		return new GBAStatDAO(getMaxHP(), getMaxSTR(), getMaxSKL(), getMaxSPD(), getMaxDEF(), getMaxRES(), getMaxLCK());
	}
	...
	public GBAStatDAO getPromoBoni() {
		return new GBAStatDAO(getPromoHP(), getPromoSTR(), getPromoSKL(), getPromoSPD(), getPromoDEF(), getPromoRES(), 0);
	}
