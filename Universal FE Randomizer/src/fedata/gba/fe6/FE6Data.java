...
public class FE6Data implements GBAFECharacterProvider, GBAFEClassProvider, GBAFEItemProvider {
	...
	public static final long PromotionItemTablePointer = 0x237AC; // Hero's Crest (0), Knights Crest (1), Orion Bolt
																	// (2), Elysian Whip (3), Guiding Ring (8)
...
//		ranges.add(new AddressRange(0xB013F0L, 0xFFFFFFL));
	...
	public enum CharacterAndClassAbility1Mask {
		USE_MOUNTED_AID(0x1), CANTO(0x2), STEAL(0x4), USE_LOCKPICKS(0x8), DANCE_(0x10), PLAY(0x20), CRIT30(0x40),
		BALLISTA(0x80);
	...
	public enum CharacterAndClassAbility3Mask {
		RAPIER_LOCK(0x1), WO_DAO_LOCK(0x2), DRAGONSTONE_LOCK(0x4), UNKNOWN(0x8), UNKNOWN_2(0x10),
		PEGASUS_TRIANGLE(0x20), KNIGHT_TRIANGLE(0x40), NPC(0x80);
	...
	public enum Character implements GBAFECharacter {
		...
		ROY(0x01), CLARINE(0x02), FA(0x03), SHIN(0x04), SUE(0x05), DAYAN(0x06), BARTH(0x08), BORS(0x09), WENDY(0x0A),
		DOUGLAS(0x0B), WOLT(0x0D), DOROTHY(0x0E), KLEIN(0x0F), SAUL(0x10), ELEN(0x11), YODEL(0x12), CHAD(0x14),
		KAREL(0x15), FIR(0x16), RUTGER(0x17), DIECK(0x18), OUJAY(0x19), GARET(0x1A), ALAN(0x1B), LANCE(0x1C),
		PERCIVAL(0x1D), IGRENE(0x1E), MARCUS(0x1F), ASTOL(0x20), WARD(0x21), LOT(0x22), BARTRE(0x23), LUGH(0x25),
		LILINA(0x26), HUGH(0x27), NIIME(0x28), REI(0x2A), LALAM(0x2B), YUNNO(0x2C), THITO(0x2E), THANY(0x31),
		ZEISS(0x32), GALE(0x33), ELFIN(0x34), CASS(0x35), SOPHIA(0x36), MILEDY(0x37), GONZALES(0x38), NOAH(0x3A),
		TRECK(0x3B), ZEALOT(0x3C), ECHIDNA(0x3D), CECILIA(0x3F), GEESE(0x40),

		MERLINUS(0x42), ELIWOOD(0x43), GUINEVERE(0x44), HECTOR(0xCF),

		KLEIN_UNIT(0xD8), TATE_UNIT(0xD9),

		DAYAN_NPC(0x07), DOUGLAS_NPC(0x0C), YODEL_NPC(0x13), BARTRE_NPC(0x24), NIIME_NPC(0x29), YUNNO_NPC(0x2D),
		THITO_NPC(0x30), GONZALES_NPC(0x39), ECHIDNA_NPC(0x3E), GEESE_NPC(0x40),

		THITO_ENEMY(0x2F),

		DAMAS(0x4A), RUDE(0x4B), SLATER(0x4C), ERIK(0x4D), DORY(0x4E), WAGNER(0x4F), DEVIAS(0x50), LEGYLANCE(0x51),
		SCOTT(0x52), NORD(0x53), FLAER(0x55), ORO(0x56), ROBARTS(0x57), AINE(0x58), NARSHEN(0x59), RANDY(0x5A),
		ROSE(0x5B), MAGGIE(0x5C), RAETH(0x5D), ARCARD(0x5E), MARTEL(0x5F), SIGUNE(0x60), ROARTZ(0x61), MURDOCK(0x62),
		BRUNYA(0x63), ZINC(0x68), MONKE(0x69), GEL(0x6A), HENNING(0xB5), SCOLLAN(0xB6), GRERO(0xB8), OHTZ(0xB9),
		TECK(0xBA), THORIL(0xBE), BRAKUL(0xBF), KUDOKA(0xC0), MARRAL(0xC1), KABUL(0xC2), CHAN(0xC3), PERETH(0xC4),
		WINDAM(0xC6), MORGAN(0xC8),
		...
		public static Set<Character> allPlayableCharacters = new HashSet<Character>(
				Arrays.asList(ROY, CLARINE, FA, SHIN, SUE, DAYAN, BARTH, BORS, WENDY, DOUGLAS, WOLT, DOROTHY, KLEIN,
						SAUL, ELEN, YODEL, CHAD, KAREL, FIR, RUTGER, DIECK, OUJAY, GARET, ALAN, LANCE, PERCIVAL, IGRENE,
						MARCUS, ASTOL, WARD, LOT, BARTRE, LUGH, LILINA, HUGH, NIIME, REI, LALAM, YUNNO, THITO, THANY,
						ZEISS, ELFIN, CASS, SOPHIA, MILEDY, GONZALES, NOAH, TRECK, ZEALOT, ECHIDNA, CECILIA, GEESE));

		public static Set<Character> allBossCharacters = new HashSet<Character>(Arrays.asList(DAMAS, RUDE, SLATER, ERIK,
				DORY, WAGNER, DEVIAS, LEGYLANCE, SCOTT, NORD, FLAER, ORO, ROBARTS, AINE, NARSHEN, RANDY, ROSE, MAGGIE,
				RAETH, ARCARD, MARTEL, SIGUNE, ROARTZ, MURDOCK, BRUNYA, ZINC, MONKE, GEL, HENNING, SCOLLAN, GRERO, OHTZ,
				TECK, THORIL, BRAKUL, KUDOKA, MARRAL, KABUL, CHAN, PERETH, WINDAM, MORGAN));

		public static Set<Character> restrictedClassCharacters = new HashSet<Character>(
				Arrays.asList(THITO, MILEDY, GALE, NARSHEN, ROY));
		...
		public static Set<Character> doNotChange = new HashSet<Character>(
				Arrays.asList(ZEPHIEL, YAHN, IDOUN, MERLINUS, FA));
		...
		public static Set<Character> requiredFliers = new HashSet<Character>(
				Arrays.asList(THITO, MILEDY, GALE, NARSHEN));
		public static Set<Character> requiredAttackers = new HashSet<Character>(Arrays.asList(ROY, CECILIA));

		public static Set<Character> femaleSet = new HashSet<Character>(
				Arrays.asList(CLARINE, FA, SUE, WENDY, DOROTHY, ELEN, FIR, IGRENE, LILINA, NIIME, LALAM, YUNNO, THITO,
						THANY, CASS, SOPHIA, MILEDY, ECHIDNA, CECILIA, GUINEVERE, TATE_UNIT, NIIME_NPC, YUNNO_NPC,
						THITO_NPC, ECHIDNA_NPC, THITO_ENEMY, SIGUNE, BRUNYA, IDOUN));
	...
	public enum CharacterClass implements GBAFEClass {
		...
		LORD(0x01), MERCENARY(0x02), MYRMIDON(0x06), FIGHTER(0x0A), KNIGHT(0x0C), ARCHER(0x10), PRIEST(0x14),
		MAGE(0x18), SHAMAN(0x1C), CAVALIER(0x20), NOMAD(0x26), WYVERN_RIDER(0x2C), SOLDIER(0x30), BRIGAND(0x31),
		PIRATE(0x32), THIEF(0x34), BARD(0x36),

		HERO(0x04), SWORDMASTER(0x08), WARRIOR(0x0B), GENERAL(0x0E), SNIPER(0x12), BISHOP(0x16), SAGE(0x1A),
		DRUID(0x1E), PALADIN(0x22), NOMAD_TROOPER(0x28), WYVERN_KNIGHT(0x2E), BERSERKER(0x33), MANAKETE(0x38),
		MASTER_LORD(0x43),

		MYRMIDON_F(0x07), KNIGHT_F(0x0D), ARCHER_F(0x11), CLERIC(0x15), MAGE_F(0x19), SHAMAN_F(0x1D), TROUBADOUR(0x24),
		NOMAD_F(0x27), PEGASUS_KNIGHT(0x2A), WYVERN_RIDER_F(0x2D), THIEF_F(0x35), DANCER(0x37),

		HERO_F(0x05), SWORDMASTER_F(0x09), GENERAL_F(0x0F), SNIPER_F(0x13), BISHOP_F(0x17), SAGE_F(0x1B), DRUID_F(0x1F),
		VALKYRIE(0x25), NOMAD_TROOPER_F(0x29), FALCON_KNIGHT(0x2B), WYVERN_KNIGHT_F(0x2F), MANAKETE_F(0x39),
		...
		public static Set<CharacterClass> allMaleClasses = new HashSet<CharacterClass>(Arrays.asList(LORD, MERCENARY,
				MYRMIDON, FIGHTER, KNIGHT, ARCHER, PRIEST, MAGE, SHAMAN, CAVALIER, NOMAD, WYVERN_RIDER, SOLDIER,
				BRIGAND, PIRATE, THIEF, BARD, HERO, SWORDMASTER, WARRIOR, GENERAL, SNIPER, BISHOP, SAGE, DRUID, PALADIN,
				NOMAD_TROOPER, WYVERN_KNIGHT, BERSERKER, /* MANAKETE, */ MASTER_LORD));
		public static Set<CharacterClass> allFemaleClasses = new HashSet<CharacterClass>(Arrays.asList(MYRMIDON_F,
				KNIGHT_F, ARCHER_F, CLERIC, MAGE_F, SHAMAN_F, TROUBADOUR, NOMAD_F, PEGASUS_KNIGHT, WYVERN_RIDER_F,
				THIEF_F, DANCER, HERO_F, SWORDMASTER_F, GENERAL_F, SNIPER_F, BISHOP_F, SAGE_F, DRUID_F, VALKYRIE,
				NOMAD_TROOPER_F, FALCON_KNIGHT, WYVERN_KNIGHT_F, MANAKETE_F));
		public static Set<CharacterClass> allLordClasses = new HashSet<CharacterClass>(
				Arrays.asList(LORD, MASTER_LORD));
		...
		public static Set<CharacterClass> allSpecialClasses = new HashSet<CharacterClass>(
				Arrays.asList(DANCER, BARD, MANAKETE_F));
		public static Set<CharacterClass> allUnpromotedClasses = new HashSet<CharacterClass>(
				Arrays.asList(LORD, MERCENARY, MYRMIDON, FIGHTER, KNIGHT, ARCHER, PRIEST, MAGE, SHAMAN, CAVALIER, NOMAD,
						WYVERN_RIDER, SOLDIER, BRIGAND, PIRATE, THIEF, BARD, MYRMIDON_F, KNIGHT_F, ARCHER_F, CLERIC,
						MAGE_F, SHAMAN_F, TROUBADOUR, NOMAD_F, PEGASUS_KNIGHT, WYVERN_RIDER_F, THIEF_F, DANCER));
		public static Set<CharacterClass> allPromotedClasses = new HashSet<CharacterClass>(Arrays.asList(MASTER_LORD,
				HERO, SWORDMASTER, WARRIOR, GENERAL, SNIPER, BISHOP, SAGE, DRUID, PALADIN, NOMAD_TROOPER, WYVERN_KNIGHT,
				BERSERKER, /* MANAKETE, */ MASTER_LORD, HERO_F, SWORDMASTER_F, GENERAL_F, SNIPER_F, BISHOP_F, SAGE_F,
				DRUID_F, VALKYRIE, NOMAD_TROOPER_F, FALCON_KNIGHT, WYVERN_KNIGHT_F, MANAKETE_F));
		public static Set<CharacterClass> allPacifistClasses = new HashSet<CharacterClass>(
				Arrays.asList(DANCER, BARD, PRIEST, CLERIC, TROUBADOUR));
		public static Set<CharacterClass> allMeleeLockedClasses = new HashSet<CharacterClass>(
				Arrays.asList(MYRMIDON, MERCENARY, LORD, THIEF));

		public static Set<CharacterClass> allValidClasses = new HashSet<CharacterClass>(Arrays.asList(LORD, MERCENARY,
				MYRMIDON, FIGHTER, KNIGHT, ARCHER, PRIEST, MAGE, SHAMAN, CAVALIER, NOMAD, WYVERN_RIDER, SOLDIER,
				BRIGAND, PIRATE, THIEF, BARD, HERO, SWORDMASTER, WARRIOR, GENERAL, SNIPER, BISHOP, SAGE, DRUID, PALADIN,
				NOMAD_TROOPER, WYVERN_KNIGHT, BERSERKER, /* MANAKETE, */ MASTER_LORD, MYRMIDON_F, KNIGHT_F, ARCHER_F,
				CLERIC, MAGE_F, SHAMAN_F, TROUBADOUR, NOMAD_F, PEGASUS_KNIGHT, WYVERN_RIDER_F, THIEF_F, DANCER, HERO_F,
				SWORDMASTER_F, GENERAL_F, SNIPER_F, BISHOP_F, SAGE_F, DRUID_F, VALKYRIE, NOMAD_TROOPER_F, FALCON_KNIGHT,
				WYVERN_KNIGHT_F/* , MANAKETE_F */));

		public static Set<CharacterClass> allPlayerOnlyClasses = new HashSet<CharacterClass>(
				Arrays.asList(BARD, DANCER));

		public static Set<CharacterClass> flyingClasses = new HashSet<>(
				Arrays.asList(WYVERN_KNIGHT, WYVERN_KNIGHT_F, WYVERN_RIDER, WYVERN_RIDER_F, PEGASUS_KNIGHT));

		public static Set<CharacterClass> allMountedClasses = new HashSet<>(Arrays.asList(CAVALIER, CAVALIER_F, PALADIN,
				PALADIN_F, TROUBADOUR, VALKYRIE, NOMAD, NOMAD_F, NOMAD_TROOPER, NOMAD_TROOPER_F));

		// Includes most sword locks. Yes, they gain range with magic swords, but we're
		// not going to assume they can use magic swords.
		public static Set<CharacterClass> meleeOnlyClasses = new HashSet<CharacterClass>(Arrays.asList(LORD, MERCENARY,
				MYRMIDON, SWORDMASTER, MASTER_LORD, MYRMIDON_F, THIEF, THIEF_F, SWORDMASTER_F, MANAKETE_F));
		public static Set<CharacterClass> rangedOnlyClasses = new HashSet<CharacterClass>(
				Arrays.asList(NOMAD, ARCHER, SNIPER, SNIPER_F, NOMAD_F));
		...
		private static Set<CharacterClass> limitedClassesForRandomization(CharacterClass sourceClass) {
			...
			case LORD: // Special case for Roy to be able to always use swords (and have promotions)
				return new HashSet<CharacterClass>(
						Arrays.asList(LORD, MYRMIDON, MERCENARY, MYRMIDON_F, CAVALIER, PEGASUS_KNIGHT, NOMAD));
			case THIEF_F: // Temporary fix to make sure the game is playable. Thief AI tends to lock up
							// the game if they're randomized to something else. The only relevent thief for
							// us is Cath.
			...
			case BRIGAND:
				return new HashSet<CharacterClass>(
						Arrays.asList(BRIGAND, WYVERN_RIDER, WYVERN_RIDER_F, PEGASUS_KNIGHT));
			case BERSERKER:
				return new HashSet<CharacterClass>(
						Arrays.asList(BERSERKER, WYVERN_KNIGHT, WYVERN_KNIGHT_F, FALCON_KNIGHT));
			default:
				return null;
			}
		}
	...
	public enum Item implements GBAFEItem {
		...
		IRON_SWORD(0x01), IRON_BLADE(0x02), STEEL_SWORD(0x03), SILVER_SWORD(0x04), SLIM_SWORD(0x05), POISON_SWORD(0x06),
		BRAVE_SWORD(0x07), LIGHT_BRAND(0x08), ARMORSLAYER(0x0A), RAPIER(0x0B), KILLING_EDGE(0x0C), LANCEREAVER(0x0D),
		WO_DAO(0x0E), STEEL_BLADE(0x72), SILVER_BLADE(0x73), AL_SWORD(0x74), WYRMSLAYER(0x78), RUNE_SWORD(0x7D),

		IRON_LANCE(0x10), STEEL_LANCE(0x11), SILVER_LANCE(0x12), SLIM_LANCE(0x13), POISON_LANCE(0x14),
		BRAVE_LANCE(0x15), JAVELIN(0x16), HORSESLAYER(0x18), KILLER_LANCE(0x19), AXEREAVER(0x1A), GANT_LANCE(0x75),
		SPEAR(0x7E),

		IRON_AXE(0x1B), STEEL_AXE(0x1C), SILVER_AXE(0x1D), POISON_AXE(0x1E), BRAVE_AXE(0x1F), HAND_AXE(0x20),
		HAMMER(0x22), KILLER_AXE(0x23), SWORDREAVER(0x24), DEVIL_AXE(0x25), HALBERD(0x26), TOMAHAWK(0x7F),

		IRON_BOW(0x27), STEEL_BOW(0x28), SILVER_BOW(0x29), POISON_BOW(0x2A), KILLER_BOW(0x2B), BRAVE_BOW(0x2C),
		SHORT_BOW(0x2D), LONGBOW(0x2E),
		...
		HEAL(0x43), MEND(0x44), RECOVER(0x45), PHYSIC(0x46), FORTIFY(0x47), WARP(0x48), RESCUE(0x49), RESTORE(0x4A),
		SILENCE(0x4B), SLEEP(0x4C), TORCH_STAFF(0x4D), HAMMERNE(0x4E), BERSERK(0x50), UNLOCK(0x51), BARRIER(0x52),
		TINA_STAFF(0x76), HOLY_MAIDEN(0x77),
		...
		SECRET_BOOK(0x56), GODDESS_ICON(0x57), ANGELIC_ROBE(0x58), DRAGON_SHIELD(0x59), ENERGY_RING(0x5A),
		SPEEDWING(0x5B), TALISMAN(0x5C), BOOTS(0x5D), BODY_RING(0x5E),
		...
		public enum FE6WeaponRank {
			...
			private FE6WeaponRank(final int value) {
				this.value = value;
			}
		...
		public enum FE6WeaponType {
			...
			private FE6WeaponType(final int id) {
				ID = id;
			}
		...
		public enum Ability1Mask {
			...
			MAGICDAMAGE(0x40), UNCOUNTERABLE(0x80);
		...
		public enum Ability2Mask {
			NONE(0x00), REVERSE_WEAPON_TRIANGLE(0x01), DRAGONSTONE_LOCK(0x04), LORD_LOCK(0x08), MYRMIDON_LOCK(0x10),
			KING_LOCK(0x20), IOTE_SHIELD_EFFECT(0x40);
		...
		public static Set<Item> allSwords = new HashSet<Item>(
				Arrays.asList(IRON_SWORD, SLIM_SWORD, RAPIER, AL_SWORD, POISON_SWORD, STEEL_SWORD, IRON_BLADE,
						ARMORSLAYER, WO_DAO, STEEL_BLADE, KILLING_EDGE, WYRMSLAYER, LIGHT_BRAND, LANCEREAVER,
						BRAVE_SWORD, SILVER_SWORD, SILVER_BLADE, RUNE_SWORD, DURANDAL, ECKESACHS, BINDING_BLADE));
		public static Set<Item> allLances = new HashSet<Item>(
				Arrays.asList(IRON_LANCE, STEEL_LANCE, SILVER_LANCE, SLIM_LANCE, POISON_LANCE, BRAVE_LANCE, JAVELIN,
						MALTET, HORSESLAYER, KILLER_LANCE, AXEREAVER, GANT_LANCE, SPEAR));
		public static Set<Item> allAxes = new HashSet<Item>(Arrays.asList(IRON_AXE, STEEL_AXE, SILVER_AXE, POISON_AXE,
				BRAVE_AXE, HAND_AXE, ARMADS, HAMMER, KILLER_AXE, SWORDREAVER, DEVIL_AXE, HALBERD, TOMAHAWK));
		public static Set<Item> allBows = new HashSet<Item>(Arrays.asList(IRON_BOW, STEEL_BOW, SILVER_BOW, POISON_BOW,
				KILLER_BOW, BRAVE_BOW, SHORT_BOW, LONGBOW, MURGLEIS));
		public static Set<Item> allAnima = new HashSet<Item>(
				Arrays.asList(FIRE, THUNDER, FIMBULVETR, ELFIRE, AIRCALIBUR, BOLTING, FORBLAZE));
		...
		public static Set<Item> allDark = new HashSet<Item>(
				Arrays.asList(FLUX, NOSFERATU, ECLIPSE, FENRIR, APOCALYPSE));
		public static Set<Item> allHealingStaves = new HashSet<Item>(
				Arrays.asList(HEAL, MEND, RECOVER, PHYSIC, FORTIFY, TINA_STAFF, HOLY_MAIDEN));
		...
		public static Set<Item> allStatBoosters = new HashSet<Item>(Arrays.asList(ANGELIC_ROBE, ENERGY_RING,
				SECRET_BOOK, SPEEDWING, GODDESS_ICON, DRAGON_SHIELD, TALISMAN, BOOTS, BODY_RING));
		...
		public static Set<Item> allSpecialItems = new HashSet<Item>(
				Arrays.asList(DELPHI_SHIELD, MEMBER_CARD, SILVER_CARD));
		public static Set<Item> allMoneyItems = new HashSet<Item>(Arrays.asList(WHITE_GEM, BLUE_GEM, RED_GEM));
		public static Set<Item> usableItems = new HashSet<Item>(
				Arrays.asList(CHEST_KEY_5, DOOR_KEY, LOCKPICK, VULNERARY, ELIXIR, PURE_WATER, ANTITOXIN, TORCH));

		public static Set<Item> allPotentialRewards = new HashSet<Item>(
				Arrays.asList(/* IRON_SWORD, SLIM_SWORD, IRON_LANCE, SLIM_LANCE, */ JAVELIN,
						/* POISON_LANCE, */ HAND_AXE, /* IRON_AXE, */ STEEL_AXE, DEVIL_AXE,
						/* IRON_BOW, FIRE, LIGHTNING, HEAL, POISON_SWORD, */ STEEL_SWORD, IRON_BLADE, ARMORSLAYER,
						WO_DAO, STEEL_LANCE, HORSESLAYER, /* POISON_AXE, */ HALBERD, HAMMER, /* POISON_BOW, */
						SHORT_BOW, LONGBOW, STEEL_BOW, THUNDER, FLUX, MEND, TORCH_STAFF, UNLOCK, STEEL_BLADE,
						KILLING_EDGE, WYRMSLAYER, LIGHT_BRAND, LANCEREAVER, KILLER_LANCE, AXEREAVER, KILLER_AXE,
						SWORDREAVER, KILLER_BOW, ELFIRE, AIRCALIBUR, DIVINE, NOSFERATU, RECOVER, RESTORE, HAMMERNE,
						BARRIER, BRAVE_SWORD, BRAVE_LANCE, SPEAR, BRAVE_AXE, BRAVE_BOW, BOLTING, PURGE, ECLIPSE, PHYSIC,
						SILENCE, SLEEP, BERSERK, RESCUE, SILVER_SWORD, SILVER_BLADE, RUNE_SWORD, SILVER_LANCE, TOMAHAWK,
						SILVER_AXE, SILVER_BOW, FIMBULVETR, FENRIR, FORTIFY, WARP, AL_SWORD, GANT_LANCE, TINA_STAFF,
						ANGELIC_ROBE, ENERGY_RING, SECRET_BOOK, SPEEDWING, GODDESS_ICON, DRAGON_SHIELD, TALISMAN, BOOTS,
						BODY_RING, HERO_CREST, KNIGHT_CREST, ORION_BOLT, ELYSIAN_WHIP, GUIDING_RING, DELPHI_SHIELD,
						MEMBER_CARD, SILVER_CARD, WHITE_GEM, BLUE_GEM, RED_GEM));

		public static Set<Item> commonDrops = new HashSet<Item>(
				Arrays.asList(VULNERARY, ELIXIR, ANTITOXIN, PURE_WATER, TORCH, CHEST_KEY_5, DOOR_KEY, RED_GEM));
		public static Set<Item> uncommonDrops = new HashSet<Item>(
				Arrays.asList(HERO_CREST, KNIGHT_CREST, ORION_BOLT, ELYSIAN_WHIP, GUIDING_RING, BLUE_GEM));
		...
		public static Set<Item> allWeapons = new HashSet<Item>(Arrays.asList(IRON_SWORD, SLIM_SWORD, RAPIER, AL_SWORD,
				POISON_SWORD, STEEL_SWORD, IRON_BLADE, ARMORSLAYER, WO_DAO, STEEL_BLADE, KILLING_EDGE, WYRMSLAYER,
				LIGHT_BRAND, LANCEREAVER, BRAVE_SWORD, SILVER_SWORD, SILVER_BLADE, RUNE_SWORD, DURANDAL, ECKESACHS,
				BINDING_BLADE, IRON_LANCE, STEEL_LANCE, SILVER_LANCE, SLIM_LANCE, POISON_LANCE, BRAVE_LANCE, JAVELIN,
				MALTET, HORSESLAYER, KILLER_LANCE, AXEREAVER, GANT_LANCE, SPEAR, IRON_AXE, STEEL_AXE, SILVER_AXE,
				POISON_AXE, BRAVE_AXE, HAND_AXE, ARMADS, HAMMER, KILLER_AXE, SWORDREAVER, DEVIL_AXE, HALBERD, TOMAHAWK,
				IRON_BOW, STEEL_BOW, SILVER_BOW, POISON_BOW, KILLER_BOW, BRAVE_BOW, SHORT_BOW, LONGBOW, MURGLEIS, FIRE,
				THUNDER, FIMBULVETR, ELFIRE, AIRCALIBUR, BOLTING, FORBLAZE, LIGHTNING, DIVINE, PURGE, AUREOLA, FLUX,
				NOSFERATU, ECLIPSE, FENRIR, APOCALYPSE));
		public static Set<Item> allRangedWeapons = new HashSet<Item>(Arrays.asList(LIGHT_BRAND, RUNE_SWORD, ECKESACHS,
				BINDING_BLADE, JAVELIN, SPEAR, HAND_AXE, TOMAHAWK, IRON_BOW, STEEL_BOW, SILVER_BOW, POISON_BOW,
				KILLER_BOW, BRAVE_BOW, SHORT_BOW, LONGBOW, MURGLEIS, FIRE, THUNDER, ELFIRE, FIMBULVETR, FORBLAZE,
				AIRCALIBUR, LIGHTNING, DIVINE, AUREOLA, FLUX, NOSFERATU, FENRIR, APOCALYPSE));
		public static Set<Item> allStaves = new HashSet<Item>(
				Arrays.asList(HEAL, MEND, RECOVER, PHYSIC, FORTIFY, RESTORE, WARP, RESCUE, TORCH_STAFF, HAMMERNE,
						UNLOCK, BARRIER, SILENCE, SLEEP, BERSERK, TINA_STAFF, HOLY_MAIDEN));

		public static Set<Item> allSiegeTomes = new HashSet<Item>(Arrays.asList(BOLTING, PURGE, ECLIPSE));

		public static Set<Item> allERank = new HashSet<Item>(
				Arrays.asList(IRON_SWORD, SLIM_SWORD, IRON_LANCE, SLIM_LANCE, JAVELIN, POISON_LANCE, HAND_AXE, IRON_AXE,
						STEEL_AXE, DEVIL_AXE, IRON_BOW, FIRE, LIGHTNING, HEAL, TINA_STAFF));
		public static Set<Item> allDRank = new HashSet<Item>(Arrays.asList(AL_SWORD, POISON_SWORD, STEEL_SWORD,
				IRON_BLADE, ARMORSLAYER, WO_DAO, STEEL_LANCE, GANT_LANCE, HORSESLAYER, POISON_AXE, HALBERD, HAMMER,
				POISON_BOW, SHORT_BOW, LONGBOW, STEEL_BOW, THUNDER, FLUX, MEND, TORCH_STAFF, UNLOCK));
		public static Set<Item> allCRank = new HashSet<Item>(Arrays.asList(STEEL_BLADE, KILLING_EDGE, WYRMSLAYER,
				LIGHT_BRAND, LANCEREAVER, KILLER_LANCE, AXEREAVER, KILLER_AXE, SWORDREAVER, KILLER_BOW, ELFIRE, DIVINE,
				NOSFERATU, RECOVER, RESTORE, HAMMERNE, BARRIER));
		public static Set<Item> allBRank = new HashSet<Item>(Arrays.asList(BRAVE_SWORD, BRAVE_LANCE, SPEAR, BRAVE_AXE,
				BRAVE_BOW, AIRCALIBUR, ECLIPSE, PHYSIC, SILENCE, SLEEP, BERSERK, RESCUE));
		public static Set<Item> allARank = new HashSet<Item>(Arrays.asList(SILVER_SWORD, SILVER_BLADE, RUNE_SWORD,
				SILVER_LANCE, TOMAHAWK, SILVER_AXE, SILVER_BOW, FIMBULVETR, BOLTING, PURGE, FENRIR, FORTIFY, WARP));
		public static Set<Item> allSRank = new HashSet<Item>(
				Arrays.asList(DURANDAL, MALTET, ARMADS, MURGLEIS, FORBLAZE, APOCALYPSE, HOLY_MAIDEN, AUREOLA));
		public static Set<Item> allPrfRank = new HashSet<Item>(Arrays.asList(RAPIER, BINDING_BLADE, ECKESACHS));

		public static Set<Item> normalSet = new HashSet<Item>(Arrays.asList(IRON_SWORD, SLIM_SWORD, AL_SWORD,
				STEEL_SWORD, IRON_BLADE, STEEL_BLADE, SILVER_SWORD, SILVER_BLADE, IRON_LANCE, STEEL_LANCE, SILVER_LANCE,
				SLIM_LANCE, GANT_LANCE, IRON_AXE, STEEL_AXE, SILVER_AXE, IRON_BOW, STEEL_BOW, SILVER_BOW, FIRE, THUNDER,
				FIMBULVETR, ELFIRE, LIGHTNING, DIVINE, FLUX, FENRIR, HEAL, MEND, RECOVER, TINA_STAFF));
		public static Set<Item> interestingSet = new HashSet<Item>(Arrays.asList(RAPIER, POISON_SWORD, ARMORSLAYER,
				WO_DAO, KILLING_EDGE, WYRMSLAYER, LIGHT_BRAND, LANCEREAVER, BRAVE_SWORD, RUNE_SWORD, POISON_LANCE,
				BRAVE_LANCE, JAVELIN, HORSESLAYER, KILLER_LANCE, AXEREAVER, SPEAR, POISON_AXE, BRAVE_AXE, HAND_AXE,
				HAMMER, KILLER_AXE, SWORDREAVER, DEVIL_AXE, HALBERD, TOMAHAWK, POISON_BOW, KILLER_BOW, BRAVE_BOW,
				SHORT_BOW, LONGBOW, THUNDER, AIRCALIBUR, BOLTING, PURGE, NOSFERATU, ECLIPSE, PHYSIC, FORTIFY, RESTORE,
				WARP, RESCUE, TORCH_STAFF, HAMMERNE, UNLOCK, BARRIER, SILENCE, SLEEP, BERSERK, HOLY_MAIDEN));
		public static Set<Item> promoSet = new HashSet<Item>(Arrays.asList());

		public static Set<Item> playerOnlySet = new HashSet<Item>(
				Arrays.asList(TORCH_STAFF, UNLOCK, RESTORE, HAMMERNE, BARRIER, RESCUE, WARP, TINA_STAFF));
		...
		public static Set<Item> killerSet = new HashSet<Item>(
				Arrays.asList(KILLING_EDGE, WO_DAO, KILLER_LANCE, KILLER_AXE, KILLER_BOW));
		public static Set<Item> effectiveSet = new HashSet<Item>(
				Arrays.asList(ARMORSLAYER, WYRMSLAYER, RAPIER, HORSESLAYER, HAMMER, HALBERD, AIRCALIBUR));
		public static Set<Item> poisonSet = new HashSet<Item>(
				Arrays.asList(POISON_SWORD, POISON_LANCE, POISON_AXE, POISON_BOW));
		public static Set<Item> rangedSet = new HashSet<Item>(Arrays.asList(LIGHT_BRAND, RUNE_SWORD, JAVELIN, SPEAR,
				HAND_AXE, TOMAHAWK, LONGBOW, BOLTING, PURGE, ECLIPSE, PHYSIC));
		...
		public static Set<Item> lockedWeaponsToClassID(int classID) {
			if (classID == FE6Data.CharacterClass.MYRMIDON.ID || classID == FE6Data.CharacterClass.MYRMIDON_F.ID
					|| classID == FE6Data.CharacterClass.SWORDMASTER.ID
					|| classID == FE6Data.CharacterClass.SWORDMASTER_F.ID) {
	...
	public enum ChapterMetadata implements GBAFEChapterMetadataChapter {
		...
		CHAPTER_1_DAWN_OF_DESTINY(0x1), CHAPTER_2_THE_PRINCESS_OF_BERN(0x2), CHAPTER_3_LATE_ARRIVAL(0x3),
		CHAPTER_4_COLLAPSE_OF_THE_ALLIANCE(0x4), CHAPTER_5_THE_EMBLEM_OF_FIRE(0x5), CHAPTER_6_THE_TRAP(0x6),
		CHAPTER_7_THE_REBELLION_OF_OSTIA(0x7), CHAPTER_8_THE_REUNION(0x8), CHAPTER_9_THE_MISTY_ISLES(0x9),
		CHAPTER_10A_THE_RESISTANCE_FORCES(0xA), CHAPTER_11A_THE_HERO_OF_THE_WESTERN_ISLES(0xB),
		CHAPTER_12_THE_TRUE_ENEMY(0xC), CHAPTER_13_THE_RESCUE_PLAN(0xD), CHAPTER_14_ARCADIA(0xE),
		CHAPTER_15_THE_DRAGON_GIRL(0xF), CHAPTER_16_RETAKING_THE_CAPITAL(0x10),
		CHAPTER_17A_THE_PATH_THROUGH_THE_OCEAN(0x11), CHAPTER_18A_THE_FROZEN_RIVER(0x12), CHAPTER_19A_BITTER_COLD(0x13),
		CHAPTER_20A_THE_LIBERATION_OF_ILIA(0x14), CHAPTER_21_THE_BINDING_BLADE(0x15),
		CHAPTER_22_THE_NEVERENDING_DREAM(0x16), CHAPTER_23_THE_GHOST_OF_BERN(0x17),
		CHAPTER_24_THE_TRUTH_OF_THE_LEGEND(0x18), FINAL_BEYOND_DARKNESS(0x19),

		CHAPTER_10B_CAUGHT_IN_THE_MIDDLE(0x1A), CHAPTER_11B_ESCAPE_TO_FREEDOM(0x1B),

		CHAPTER_17B_THE_BISHOPS_TEACHING(0x1C), CHAPTER_18B_THE_LAWS_OF_SACAE(0x1D), CHAPTER_19B_BATTLE_IN_BULGAR(0x1E),
		CHAPTER_20B_THE_SILVER_WOLF(0x1F),

		CHAPTER_8X_THE_BLAZING_SWORD(0x20), CHAPTER_12X_THE_AXE_OF_THUNDER(0x21),
		CHAPTER_14X_THE_INFERNAL_ELEMENT(0x22), CHAPTER_16X_THE_PINNACLE_OF_LIGHT(0x23),
		CHAPTER_20AX_THE_SPEAR_OF_ICE(0x24), CHAPTER_20BX_THE_BOW_OF_THE_WINDS(0x25),
		...
		public static ChapterMetadata[] orderedChapters() {
			return new ChapterMetadata[] { CHAPTER_1_DAWN_OF_DESTINY, CHAPTER_2_THE_PRINCESS_OF_BERN,
					CHAPTER_3_LATE_ARRIVAL, CHAPTER_4_COLLAPSE_OF_THE_ALLIANCE, CHAPTER_5_THE_EMBLEM_OF_FIRE,
					CHAPTER_6_THE_TRAP, CHAPTER_7_THE_REBELLION_OF_OSTIA, CHAPTER_8_THE_REUNION,
					CHAPTER_8X_THE_BLAZING_SWORD, CHAPTER_9_THE_MISTY_ISLES, CHAPTER_10A_THE_RESISTANCE_FORCES,
					CHAPTER_10B_CAUGHT_IN_THE_MIDDLE, CHAPTER_11A_THE_HERO_OF_THE_WESTERN_ISLES,
					CHAPTER_11B_ESCAPE_TO_FREEDOM, CHAPTER_12_THE_TRUE_ENEMY, CHAPTER_12X_THE_AXE_OF_THUNDER,
					CHAPTER_13_THE_RESCUE_PLAN, CHAPTER_14_ARCADIA, CHAPTER_14X_THE_INFERNAL_ELEMENT,
					CHAPTER_15_THE_DRAGON_GIRL, CHAPTER_16_RETAKING_THE_CAPITAL, CHAPTER_16X_THE_PINNACLE_OF_LIGHT,
					CHAPTER_17A_THE_PATH_THROUGH_THE_OCEAN, CHAPTER_17B_THE_BISHOPS_TEACHING,
					CHAPTER_18A_THE_FROZEN_RIVER, CHAPTER_18B_THE_LAWS_OF_SACAE, CHAPTER_19A_BITTER_COLD,
					CHAPTER_19B_BATTLE_IN_BULGAR, CHAPTER_20A_THE_LIBERATION_OF_ILIA, CHAPTER_20AX_THE_SPEAR_OF_ICE,
					CHAPTER_20B_THE_SILVER_WOLF, CHAPTER_20BX_THE_BOW_OF_THE_WINDS, CHAPTER_21_THE_BINDING_BLADE,
					CHAPTER_21X_THE_SILENCING_DARKNESS, CHAPTER_22_THE_NEVERENDING_DREAM, CHAPTER_23_THE_GHOST_OF_BERN,
					CHAPTER_24_THE_TRUTH_OF_THE_LEGEND, FINAL_BEYOND_DARKNESS, };
		}

		public String getFriendlyName() {
			switch (this) {
			case CHAPTER_1_DAWN_OF_DESTINY:
				return "Chapter 1: Dawn of Destiny";
			case CHAPTER_2_THE_PRINCESS_OF_BERN:
				return "Chapter 2: The Princess of Bern";
			case CHAPTER_3_LATE_ARRIVAL:
				return "Chapter 3: Late Arrival";
			case CHAPTER_4_COLLAPSE_OF_THE_ALLIANCE:
				return "Chapter 4: Collapse of the Alliance";
			case CHAPTER_5_THE_EMBLEM_OF_FIRE:
				return "Chapter 5: The Emblem of Fire";
			case CHAPTER_6_THE_TRAP:
				return "Chapter 6: The Trap";
			case CHAPTER_7_THE_REBELLION_OF_OSTIA:
				return "Chapter 7: The Rebellion of Ostia";
			case CHAPTER_8_THE_REUNION:
				return "Chapter 8: The Reunion";
			case CHAPTER_8X_THE_BLAZING_SWORD:
				return "Chapter 8x: The Blazing Sword";
			case CHAPTER_9_THE_MISTY_ISLES:
				return "Chapter 9: The Misty Isles";
			case CHAPTER_10A_THE_RESISTANCE_FORCES:
				return "Chapter 10A: The Resistance Forces";
			case CHAPTER_10B_CAUGHT_IN_THE_MIDDLE:
				return "Chapter 10B: Caught in the Middle";
			case CHAPTER_11A_THE_HERO_OF_THE_WESTERN_ISLES:
				return "Chapter 11A: The Hero of the Western Isles";
			case CHAPTER_11B_ESCAPE_TO_FREEDOM:
				return "Chapter 11B: Escape to Freedom";
			case CHAPTER_12_THE_TRUE_ENEMY:
				return "Chapter 12: The True Enemy";
			case CHAPTER_12X_THE_AXE_OF_THUNDER:
				return "Chapter 12x: The Axe of Thunder";
			case CHAPTER_13_THE_RESCUE_PLAN:
				return "Chapter 13: The Rescue Plan";
			case CHAPTER_14_ARCADIA:
				return "Chapter 14: Arcadia";
			case CHAPTER_14X_THE_INFERNAL_ELEMENT:
				return "Chapter 14x: The Infernal Element";
			case CHAPTER_15_THE_DRAGON_GIRL:
				return "Chapter 15: The Dragon Girl";
			case CHAPTER_16_RETAKING_THE_CAPITAL:
				return "Chapter 16: Retaking the Capital";
			case CHAPTER_16X_THE_PINNACLE_OF_LIGHT:
				return "Chapter 16x: The Pinnacle of Light";
			case CHAPTER_17A_THE_PATH_THROUGH_THE_OCEAN:
				return "Chapter 17A: The Path Through the Ocean";
			case CHAPTER_17B_THE_BISHOPS_TEACHING:
				return "Chapter 17B: The Bishop's Teaching";
			case CHAPTER_18A_THE_FROZEN_RIVER:
				return "Chapter 18A: The Frozen River";
			case CHAPTER_18B_THE_LAWS_OF_SACAE:
				return "Chapter 18B: The Laws of Sacae";
			case CHAPTER_19A_BITTER_COLD:
				return "Chapter 19A: Bitter Cold";
			case CHAPTER_19B_BATTLE_IN_BULGAR:
				return "Chapter 19B: Battle in Bulgar";
			case CHAPTER_20A_THE_LIBERATION_OF_ILIA:
				return "Chapter 20A: The Liberation of Ilia";
			case CHAPTER_20AX_THE_SPEAR_OF_ICE:
				return "Chapter 20Ax: The Spear of Ice";
			case CHAPTER_20B_THE_SILVER_WOLF:
				return "Chapter 20B: The Silver Wolf";
			case CHAPTER_20BX_THE_BOW_OF_THE_WINDS:
				return "Chapter 20Bx: The Bow of the Winds";
			case CHAPTER_21_THE_BINDING_BLADE:
				return "Chapter 21: The Binding Blade";
			case CHAPTER_21X_THE_SILENCING_DARKNESS:
				return "Chapter 21x: The Silencing Darkness";
			case CHAPTER_22_THE_NEVERENDING_DREAM:
				return "Chapter 22: The Neverending Dream";
			case CHAPTER_23_THE_GHOST_OF_BERN:
				return "Chapter 23: The Ghost of Bern";
			case CHAPTER_24_THE_TRUTH_OF_THE_LEGEND:
				return "Chapter 24: The Truth of the Legend";
			case FINAL_BEYOND_DARKNESS:
				return "Final: Beyond Darkness";
			default:
				return "?";
			}
		}
	...
	public enum ChapterPointer {
		CHAPTER_1(0x0C), CHAPTER_2(0x10), CHAPTER_3(0x17), CHAPTER_4(0x1B), CHAPTER_5(0x1F), CHAPTER_6(0x26),
		CHAPTER_7(0x2A), CHAPTER_8(0x31), CHAPTER_9(0x38),

		CHAPTER_10A(0x3C), CHAPTER_11A(0x43), CHAPTER_10B(0x9A), CHAPTER_11B(0x9E),

		CHAPTER_12(0x4A), CHAPTER_13(0x51), CHAPTER_14(0x57), CHAPTER_15(0x5B), CHAPTER_16(0x60),

		CHAPTER_17A(0x64), CHAPTER_18A(0x6D), CHAPTER_19A(0x71), CHAPTER_20A(0x78), CHAPTER_17B(0xA3),
		CHAPTER_18B(0xA9), CHAPTER_19B(0xAF), CHAPTER_20B(0xB6),

		CHAPTER_21(0x7F), CHAPTER_22(0x88), CHAPTER_23(0x8C), CHAPTER_24(0x93),

		CHAPTER_8X(0xBB), CHAPTER_12X(0xC1), CHAPTER_14X(0xC7), CHAPTER_16X(0xCB), CHAPTER_20AX(0xD0),
		CHAPTER_20BX(0xD3), CHAPTER_21X(0xD8),
		...
		public static List<ChapterPointer> orderedChapters() {
			return new ArrayList<ChapterPointer>(Arrays.asList(CHAPTER_1, CHAPTER_2, CHAPTER_3, CHAPTER_4, CHAPTER_5,
					CHAPTER_6, CHAPTER_7, CHAPTER_8, CHAPTER_8X, CHAPTER_9, CHAPTER_10A, CHAPTER_10B, CHAPTER_11A,
					CHAPTER_11B, CHAPTER_12, CHAPTER_12X, CHAPTER_13, CHAPTER_14, CHAPTER_14X, CHAPTER_15, CHAPTER_16,
					CHAPTER_16X, CHAPTER_17A, CHAPTER_17B, CHAPTER_18A, CHAPTER_18B, CHAPTER_19A, CHAPTER_19B,
					CHAPTER_20A, CHAPTER_20B, CHAPTER_20AX, CHAPTER_20BX, CHAPTER_21, CHAPTER_21X, CHAPTER_22,
					CHAPTER_23, CHAPTER_24, CHAPTER_FINAL));
		}
		...
		public CharacterNudge[] nudgesRequired() {
			switch (this) {
			case CHAPTER_6:
				return new CharacterNudge[] { new CharacterNudge(Character.CASS.ID, 17, 23, 16, 23) }; // Cath spwans in
																										// a wall for
																										// some reason
																										// in vanilla.
																										// Move her out
		...
		public ChapterMetadata getMetadata() {
			switch (this) {
			case CHAPTER_1:
				return ChapterMetadata.CHAPTER_1_DAWN_OF_DESTINY;
			case CHAPTER_2:
				return ChapterMetadata.CHAPTER_2_THE_PRINCESS_OF_BERN;
			case CHAPTER_3:
				return ChapterMetadata.CHAPTER_3_LATE_ARRIVAL;
			case CHAPTER_4:
				return ChapterMetadata.CHAPTER_4_COLLAPSE_OF_THE_ALLIANCE;
			case CHAPTER_5:
				return ChapterMetadata.CHAPTER_5_THE_EMBLEM_OF_FIRE;
			case CHAPTER_6:
				return ChapterMetadata.CHAPTER_6_THE_TRAP;
			case CHAPTER_7:
				return ChapterMetadata.CHAPTER_7_THE_REBELLION_OF_OSTIA;
			case CHAPTER_8:
				return ChapterMetadata.CHAPTER_8_THE_REUNION;
			case CHAPTER_8X:
				return ChapterMetadata.CHAPTER_8X_THE_BLAZING_SWORD;
			case CHAPTER_9:
				return ChapterMetadata.CHAPTER_9_THE_MISTY_ISLES;
			case CHAPTER_10A:
				return ChapterMetadata.CHAPTER_10A_THE_RESISTANCE_FORCES;
			case CHAPTER_10B:
				return ChapterMetadata.CHAPTER_10B_CAUGHT_IN_THE_MIDDLE;
			case CHAPTER_11A:
				return ChapterMetadata.CHAPTER_11A_THE_HERO_OF_THE_WESTERN_ISLES;
			case CHAPTER_11B:
				return ChapterMetadata.CHAPTER_11B_ESCAPE_TO_FREEDOM;
			case CHAPTER_12:
				return ChapterMetadata.CHAPTER_12_THE_TRUE_ENEMY;
			case CHAPTER_12X:
				return ChapterMetadata.CHAPTER_12X_THE_AXE_OF_THUNDER;
			case CHAPTER_13:
				return ChapterMetadata.CHAPTER_13_THE_RESCUE_PLAN;
			case CHAPTER_14:
				return ChapterMetadata.CHAPTER_14_ARCADIA;
			case CHAPTER_14X:
				return ChapterMetadata.CHAPTER_14X_THE_INFERNAL_ELEMENT;
			case CHAPTER_15:
				return ChapterMetadata.CHAPTER_15_THE_DRAGON_GIRL;
			case CHAPTER_16:
				return ChapterMetadata.CHAPTER_16_RETAKING_THE_CAPITAL;
			case CHAPTER_16X:
				return ChapterMetadata.CHAPTER_16X_THE_PINNACLE_OF_LIGHT;
			case CHAPTER_17A:
				return ChapterMetadata.CHAPTER_17A_THE_PATH_THROUGH_THE_OCEAN;
			case CHAPTER_17B:
				return ChapterMetadata.CHAPTER_17B_THE_BISHOPS_TEACHING;
			case CHAPTER_18A:
				return ChapterMetadata.CHAPTER_18A_THE_FROZEN_RIVER;
			case CHAPTER_18B:
				return ChapterMetadata.CHAPTER_18B_THE_LAWS_OF_SACAE;
			case CHAPTER_19A:
				return ChapterMetadata.CHAPTER_19A_BITTER_COLD;
			case CHAPTER_19B:
				return ChapterMetadata.CHAPTER_19B_BATTLE_IN_BULGAR;
			case CHAPTER_20A:
				return ChapterMetadata.CHAPTER_20A_THE_LIBERATION_OF_ILIA;
			case CHAPTER_20B:
				return ChapterMetadata.CHAPTER_20B_THE_SILVER_WOLF;
			case CHAPTER_20AX:
				return ChapterMetadata.CHAPTER_20AX_THE_SPEAR_OF_ICE;
			case CHAPTER_20BX:
				return ChapterMetadata.CHAPTER_20BX_THE_BOW_OF_THE_WINDS;
			case CHAPTER_21:
				return ChapterMetadata.CHAPTER_21_THE_BINDING_BLADE;
			case CHAPTER_21X:
				return ChapterMetadata.CHAPTER_21X_THE_SILENCING_DARKNESS;
			case CHAPTER_22:
				return ChapterMetadata.CHAPTER_22_THE_NEVERENDING_DREAM;
			case CHAPTER_23:
				return ChapterMetadata.CHAPTER_23_THE_GHOST_OF_BERN;
			case CHAPTER_24:
				return ChapterMetadata.CHAPTER_24_THE_TRUTH_OF_THE_LEGEND;
			case CHAPTER_FINAL:
				return ChapterMetadata.FINAL_BEYOND_DARKNESS;
			default:
				return null;
			}
		}
	...
	public enum PromotionItem implements GBAFEPromotionItem {
		// Hero's Crest (0), Knights Crest (1), Orion Bolt (2), Elysian Whip (3),
		// Guiding Ring (8)
	...
	public enum Palette {
		...
		BRIGAND_DAMAS(0x59, Character.DAMAS.ID, CharacterClass.BRIGAND.ID, 0x7FEB30), // FE6 is so busted. The classes
																						// in the class table are
																						// straight up wrong for some
																						// characters.
		...
		WYVERN_RIDER_ZEISS(0x0, Character.ZEISS.ID, CharacterClass.WYVERN_RIDER.ID, 0x77144C), // This one is using the
																								// sprite colors.
		...
		MANAKETE_GENERIC(0x0, Character.NONE.ID, CharacterClass.MANAKETE.ID, 0x716DCB), // Based off of sprite's base
																						// palette.
		MANAKETE_FA(0x0, Character.FA.ID, CharacterClass.MANAKETE_F.ID, 0x7FF050) // TODO: Verify Fa's pointer. There's
																					// one last entry in the table
																					// that's not listed anywhere else,
																					// but Fa herself has no palette
																					// index.
		;
		...
		static {
			...
			defaultPaletteForClass.put(CharacterClass.WYVERN_RIDER.ID, WYVERN_RIDER_MILEDY.info); // Assuming male ==
																									// female for
																									// palettes here.
		...
		private Palette(int paletteID, int charID, int classID, long offset) {
			...
			if (charClass != null) {
				...
				case BISHOP:
					...
					break;
				case BISHOP_F:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 8, 5, 6 },
				...
				case DRUID_F:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 8, 9, 10 },
							new int[] { 11, 12, 13, 14 }, new int[] { 5, 6, 7 });
					break;
				case FALCON_KNIGHT:
				...
				case KNIGHT:
				case KNIGHT_F:
					this.info = new PaletteInfo(classID, charID, offset, new int[] {}, new int[] { 4, 5, 2, 3, 1 },
							new int[] {});
					break;
				case LORD:
				case MASTER_LORD:
				...
				case SAGE_F:
					...
					break;
				case MERCENARY:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 6, 7, 14 }, new int[] { 9, 3, 2 },
							new int[] {});
					break;
				case NOMAD:
				case NOMAD_F:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 6, 7, 14 }, new int[] { 4, 5 },
							new int[] { 8, 9, 10, 11 }); // Secondary is Mount/Bow
					break;
				case NOMAD_TROOPER:
				case NOMAD_TROOPER_F:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 6, 7 }, new int[] { 2, 5 },
							new int[] { 8, 9, 10, 11 });
					break;
				case PALADIN:
					this.info = new PaletteInfo(classID, charID, offset, new int[] {}, new int[] { 8, 9, 10 },
							new int[] {}, new int[] { 6, 7 }); // No hair. Armor primary, shield tertiary.
					break;
				case PEGASUS_KNIGHT:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 7, 6 }, new int[] { 9, 10, 14 },
							new int[] { 11, 12, 13 }, new int[] { 5, 3 }); // Armor Primary, Wing Secondary, Mane
																			// tertiary
					break;
				case PIRATE:
					this.info = new PaletteInfo(classID, charID, offset, new int[] {}, new int[] { 11, 12, 13, 14 },
				...
				case SHAMAN:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 8, 9, 10 },
							new int[] { 11, 12, 13 }, new int[] { 2, 5, 6 }); // Not really hair, but it matches up in
																				// the only one that matters (Canas)
					break;
				case SHAMAN_F:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 6, 7 }, new int[] { 8, 9, 10 },
							new int[] { 11, 12, 13 });
				...
				case THIEF:
				case THIEF_F:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 5, 6, 7 }, new int[] { 3, 11, 4 },
							new int[] { 12, 13, 14 }); // Primary is cape, secondary is inner cloak (+ hairband for
														// female)
					break;
				case TROUBADOUR:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 6, 7 }, new int[] { 8, 5 },
							new int[] { 9, 10, 11 });
					break;
				case VALKYRIE:
				...
				case WYVERN_RIDER_F:
					this.info = new PaletteInfo(classID, charID, offset, new int[] {}, new int[] { 3, 2 },
							new int[] { 10, 11, 12, 13 }, new int[] { 9 }); // Primary is Armor, Secondary is Wyvern
																			// Body, Tertiary is Wyvern's Wingspan
					break;
				case WYVERN_KNIGHT:
				case WYVERN_KNIGHT_F:
					this.info = new PaletteInfo(classID, charID, offset, new int[] {}, new int[] { 10, 11, 12, 13 },
							new int[] { 1, 9 }, new int[] {});
					break;
				default:
		...
		public static int maxPaletteIndex() {
			return 0x7F; // There's space for this many, but they're all 0s. Seems like they could be
							// used.
		}
		...
		public static PaletteColor[] supplementaryHairColorForCharacter(int characterID) {
			...
			switch (character) {
			case BARTH:
				return new PaletteColor[] { new PaletteColor(198, 189, 82), new PaletteColor(165, 148, 74),
						new PaletteColor(115, 107, 90) };
			case BORS:
				return new PaletteColor[] { new PaletteColor(90, 214, 74), new PaletteColor(82, 173, 74),
						new PaletteColor(66, 123, 74) };
			case DOUGLAS:
				return new PaletteColor[] { new PaletteColor(165, 123, 74), new PaletteColor(115, 90, 74),
						new PaletteColor(99, 74, 57) };
			case PERCIVAL:
				return new PaletteColor[] { new PaletteColor(255, 247, 99), new PaletteColor(231, 206, 57),
						new PaletteColor(189, 156, 57) };
			case MARCUS:
				return new PaletteColor[] { new PaletteColor(255, 231, 255), new PaletteColor(222, 198, 222),
						new PaletteColor(140, 123, 156) };
			case REI:
				return new PaletteColor[] { new PaletteColor(123, 239, 57), new PaletteColor(90, 198, 57),
						new PaletteColor(90, 132, 82) };
			case ZEISS:
				return new PaletteColor[] { new PaletteColor(239, 66, 49), new PaletteColor(206, 57, 49),
						new PaletteColor(140, 66, 57) };
			case ZEALOT:
				return new PaletteColor[] { new PaletteColor(148, 140, 156), new PaletteColor(115, 115, 132),
						new PaletteColor(99, 90, 99) };
			case WENDY:
				return new PaletteColor[] { new PaletteColor(255, 123, 222), new PaletteColor(231, 99, 189),
						new PaletteColor(173, 66, 148) };
			default:
				return null;
			}
		}
	...
	public int appearanceChapter(int characterID) {
		...
		case GONZALES:
		case NORD:
			return 10; // Chapter 10A
		case KLEIN:
		case THITO:
		case ZINC:
		case SCOLLAN:
			return 10; // Chapter 10B
		case LALAM:
		case ECHIDNA:
		case ORO:
		case ROBARTS:
			return 11; // Chapter 11A
		case ELFIN:
		case BARTRE:
		case MORGAN:
			return 11; // Chapter 11B
		case REI:
		case CASS:
		case AINE:
			return 12;
		...
		case WINDAM:
			return 16;
		case ARCARD:
			return 17; // Chapter 17A and 17B
		case MARTEL:
			return 18; // Chapter 18A
		case MONKE:
			return 18; // Chapter 18B
		case NIIME:
		case SIGUNE:
			return 19; // Chapter 19A
		case GEL:
			return 19; // Chapter 19B
		case YUNNO:
		case ROARTZ:
			return 20; // Chapter 20A
		case DAYAN:
			return 20; // Chapter 20B
		case TECK:
			return 20; // Chapter 20Ax
		case THORIL:
		case BRAKUL:
		case KUDOKA:
		case MARRAL:
	...
	public Set<GBAFECharacter> extraCharacters() {
		return new HashSet<GBAFECharacter>(Arrays.asList(Character.ZEPHIEL, Character.BRUNYA, Character.HECTOR,
				Character.MURDOCK, Character.GALE, Character.GUINEVERE, Character.ELIWOOD, Character.NARSHEN));
	}
	...
	public GBAFEClass correspondingMaleClass(GBAFEClass charClass) {
		...
		case MYRMIDON_F:
			return FE6Data.CharacterClass.MYRMIDON;
		case KNIGHT_F:
			return FE6Data.CharacterClass.KNIGHT;
		case ARCHER_F:
			return FE6Data.CharacterClass.ARCHER;
		case CLERIC:
			return FE6Data.CharacterClass.PRIEST;
		case MAGE_F:
			return FE6Data.CharacterClass.MAGE;
		case SHAMAN_F:
			return FE6Data.CharacterClass.SHAMAN;
		case NOMAD_F:
			return FE6Data.CharacterClass.NOMAD;
		case WYVERN_RIDER_F:
			return FE6Data.CharacterClass.WYVERN_RIDER;
		case THIEF_F:
			return FE6Data.CharacterClass.THIEF;
		case DANCER:
			return FE6Data.CharacterClass.BARD;
		case HERO_F:
			return FE6Data.CharacterClass.HERO;
		case SWORDMASTER_F:
			return FE6Data.CharacterClass.SWORDMASTER;
		case GENERAL_F:
			return FE6Data.CharacterClass.GENERAL;
		case SNIPER_F:
			return FE6Data.CharacterClass.SNIPER;
		case BISHOP_F:
			return FE6Data.CharacterClass.BISHOP;
		case SAGE_F:
			return FE6Data.CharacterClass.SAGE;
		case DRUID_F:
			return FE6Data.CharacterClass.DRUID;
		case NOMAD_TROOPER_F:
			return FE6Data.CharacterClass.NOMAD_TROOPER;
		case WYVERN_KNIGHT_F:
			return FE6Data.CharacterClass.WYVERN_KNIGHT;
		default:
			return charClass;
		}
	}
	...
	public GBAFEClass correspondingFemaleClass(GBAFEClass charClass) {
		switch ((FE6Data.CharacterClass) charClass) {
		case MYRMIDON:
			return FE6Data.CharacterClass.MYRMIDON_F;
		case KNIGHT:
			return FE6Data.CharacterClass.KNIGHT_F;
		case ARCHER:
			return FE6Data.CharacterClass.ARCHER_F;
		case PRIEST:
			return FE6Data.CharacterClass.CLERIC;
		case MAGE:
			return FE6Data.CharacterClass.MAGE_F;
		case SHAMAN:
			return FE6Data.CharacterClass.SHAMAN_F;
		case NOMAD:
			return FE6Data.CharacterClass.NOMAD_F;
		case WYVERN_RIDER:
			return FE6Data.CharacterClass.WYVERN_RIDER_F;
		case THIEF:
			return FE6Data.CharacterClass.THIEF_F;
		case BARD:
			return FE6Data.CharacterClass.DANCER;
		case HERO:
			return FE6Data.CharacterClass.HERO_F;
		case SWORDMASTER:
			return FE6Data.CharacterClass.SWORDMASTER_F;
		case GENERAL:
			return FE6Data.CharacterClass.GENERAL_F;
		case SNIPER:
			return FE6Data.CharacterClass.SNIPER_F;
		case BISHOP:
			return FE6Data.CharacterClass.BISHOP_F;
		case SAGE:
			return FE6Data.CharacterClass.SAGE_F;
		case DRUID:
			return FE6Data.CharacterClass.DRUID_F;
		case NOMAD_TROOPER:
			return FE6Data.CharacterClass.NOMAD_TROOPER_F;
		case WYVERN_KNIGHT:
			return FE6Data.CharacterClass.WYVERN_KNIGHT_F;
		default:
			return charClass;
		}
	}
	...
	public Set<GBAFEItem> weaponsWithStatBoosts() {
		return new HashSet<GBAFEItem>(Arrays.asList(Item.DURANDAL, Item.BINDING_BLADE, Item.MALTET, Item.ARMADS,
				Item.MURGLEIS, Item.FORBLAZE, Item.AUREOLA, Item.APOCALYPSE));
	}

	public Set<GBAFEItem> weaponsWithEffectiveness() {
		return new HashSet<GBAFEItem>(
				Arrays.asList(Item.RAPIER, Item.IRON_BOW, Item.HORSESLAYER, Item.HAMMER, Item.WYRMSLAYER));
	}
	...
	public String statBoostStringForWeapon(GBAFEItem weapon) {
		...
		if (weapon == Item.BINDING_BLADE) {
			return "+5 Defense, Resistance";
		}
		if (weapon == Item.MALTET) {
			return "+5 Skill";
		}
		if (weapon == Item.ARMADS) {
			return "+5 Defense";
		}
		if (weapon == Item.MURGLEIS) {
			return "+5 Speed";
		}
		if (weapon == Item.FORBLAZE) {
			return "+5 Luck";
		}
		if (weapon == Item.AUREOLA) {
			return "+5 Resistance";
		}
		if (weapon == Item.APOCALYPSE) {
			return "+5 Magic";
		}
	...
	public List<GBAFEClass> knightCavEffectivenessClasses() {
		...
		return new ArrayList<GBAFEClass>(Arrays.asList(CharacterClass.CAVALIER, CharacterClass.CAVALIER_F,
				...
				CharacterClass.GENERAL, CharacterClass.GENERAL_F, CharacterClass.NONE, CharacterClass.NONE)); // The
																												// first
																												// NONE
																												// gives
																												// us
	...
	public List<GBAFEClass> knightEffectivenessClasses() {
		return new ArrayList<GBAFEClass>(Arrays.asList(CharacterClass.KNIGHT, CharacterClass.KNIGHT_F,
				CharacterClass.GENERAL, CharacterClass.GENERAL_F, CharacterClass.NONE, CharacterClass.NONE));
	}

	public List<GBAFEClass> cavalryEffectivenessClasses() {
		// Nomads and Troubadours don't count in FE6.
		return new ArrayList<GBAFEClass>(Arrays.asList(CharacterClass.CAVALIER, CharacterClass.CAVALIER_F,
				CharacterClass.PALADIN, CharacterClass.PALADIN_F, CharacterClass.NONE, CharacterClass.NONE));
	}

	public List<GBAFEClass> dragonEffectivenessClasses() {
		return new ArrayList<GBAFEClass>(
				Arrays.asList(CharacterClass.FIRE_DRAGON, CharacterClass.DIVINE_DRAGON, CharacterClass.MAGIC_DRAGON,
						CharacterClass.WYVERN_RIDER, CharacterClass.WYVERN_RIDER_F, CharacterClass.WYVERN_KNIGHT,
						CharacterClass.WYVERN_KNIGHT_F, CharacterClass.NONE, CharacterClass.NONE));
	}

	public List<GBAFEClass> flierEffectivenessClasses() {
		return new ArrayList<GBAFEClass>(Arrays.asList(CharacterClass.PEGASUS_KNIGHT, CharacterClass.FALCON_KNIGHT,
				CharacterClass.WYVERN_KNIGHT, CharacterClass.WYVERN_KNIGHT_F, CharacterClass.WYVERN_RIDER,
				CharacterClass.WYVERN_RIDER_F, CharacterClass.NONE, CharacterClass.NONE));
	}
	...
	public AdditionalData effectivenessPointerType(long effectivenessPtr) {
		if (effectivenessPtr == 0x6615D4L) {
			return AdditionalData.DRAGON_EFFECT;
		}
		if (effectivenessPtr == 0x6615C1L) {
			return AdditionalData.KNIGHT_EFFECT;
		}
		if (effectivenessPtr == 0x6615C6L) {
...
//		if (effectivenessPtr == 0x6615CFL) { return AdditionalData.DRAGON_EFFECT; } // Technically, this is for the Binding Blade and the Divinestone, which aren't effective against Wyverns.
		if (effectivenessPtr == 0x6615BCL) {
			return AdditionalData.CAVALRY_EFFECT;
		}
		if (effectivenessPtr == 0x6615DBL) {
	...
	public List<GBAFEClass> additionalClassesForPromotionItem(GBAFEPromotionItem promotionItem,
		...
		if (promotionItem == PromotionItem.KNIGHT_CREST) {
			return new ArrayList<GBAFEClass>(Arrays.asList(CharacterClass.LORD, CharacterClass.SOLDIER));
		}
