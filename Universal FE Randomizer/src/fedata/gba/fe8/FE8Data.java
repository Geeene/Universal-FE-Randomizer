...
public class FE8Data implements GBAFECharacterProvider, GBAFEClassProvider, GBAFEItemProvider {
	...
	// I think all three of these pointers need to be set appropriately. I think
	// they determine different pieces of the summoner logic.
	...
	// Palettes are variable size, so we have to parse until we get to the "end" of
	// it. We know the next palette starts with 10 A0 or 10 80, so we could use
	// that...
	// public static final int BytesPerBossPalette = 80; // Play around with this.
	// Hopefully it doesn't collide with another palette.
	...
	// This is where the pointer to the heaven seal promotion classes resides. We're
	// overriding this to promote trainees, so it'll be rewritten to the new
	// address.
	public static final long HeavenSealPromotionPointer = 0x293D8L;
	public static final long HeavenSealOldAddress = 0x8ADF96L;

	// FE8 world map events are split into two halves. Thankfully they are
	// consecutive and the pointer table points to the first half of each.
	...
	// It's somewhat limited, so let's not use these unless we absolutely have to
	// (like for palettes).
	...
	public enum CharacterAndClassAbility1Mask {
		USE_MOUNTED_AID(0x1), CANTO(0x2), STEAL(0x4), USE_LOCKPICKS(0x8), DANCE(0x10), PLAY(0x20), CRIT15(0x40),
		BALLISTA(0x80);
	...
	public enum CharacterAndClassAbility2Mask {
		PROMOTED(0x1), SUPPLY_DEPOT(0x2), HORSE_ICON(0x4), WYVERN_ICON(0x8), PEGASUS_ICON(0x10), LORD(0x20),
		FEMALE(0x40), BOSS(0x80);
	...
	public enum CharacterAndClassAbility3Mask {
		UNUSED_WEAPON_LOCK(0x1), SHAMSHIR_LOCK(0x2), MONSTER_WEAPON_LOCK(0x4), MAX_LEVEL_10(0x8), UNSELECTABLE(0x10),
		TRIANGLE_ATTACK(0x20), TRIANGLE_ATTACK_2(0x40), GLITCHES(0x80);
	...
	public enum CharacterAndClassAbility4Mask {
		UNKNOWN(0x1), LETHALITY(0x2), UNKNOWN_2(0x4), SUMMON(0x8), EIRIKA_WEAPON_LOCK(0x10), EPHRAIM_WEAPON_LOCK(0x20),
		UNUSED_LYN_LOCK(0x40), UNUSED_ATHOS_LOCK(0x80);
	...
	public enum Character implements GBAFECharacter {
		...
		EIRIKA(0x01), SETH(0x02), GILLIAM(0x03), FRANZ(0x04), MOULDER(0x05), VANESSA(0x06), ROSS(0x07), NEIMI(0x08),
		COLM(0x09), GARCIA(0x0A), INNES(0x0B), LUTE(0x0C), NATASHA(0x0D), CORMAG(0x0E), EPHRAIM(0x0F), FORDE(0x10),
		KYLE(0x11), AMELIA(0x12), ARTUR(0x13), GERIK(0x14), TETHYS(0x15), MARISA(0x16), SALEH(0x17), EWAN(0x18),
		LARACHEL(0x19), DOZLA(0x1A), RENNAC(0x1C), DUESSEL(0x1D), MYRRH(0x1E), KNOLL(0x1F), JOSHUA(0x20), SYRENE(0x21),
		TANA(0x22), ORSON_5X(0x42),

		LYON(0x23), LYON_CH17(0x40), MORVA(0x41), LYON_FINAL(0x6C), DEMON_KING(0xBE),

		ORSON(0x24), SELENA(0x26), SELENA_CH10B_CH13B(0x44), VALTER(0x27), VALTER_CH15(0x43), VALTER_PROLOGUE(0x45),
		RIEV(0x28), CAELLACH(0x29), BREGUET(0x46), BONE(0x47), BAZBA(0x48), MUMMY_CH4(0x49), SAAR(0x4A), NOVALA(0x4B),
		MURRAY(0x4C), TIRADO(0x4D), BINKS(0x4E), PABLO(0x4F), MACDAIRE_CH12A(0x50), AIAS(0x51), CARLYLE(0x52),
		CAELLACH_CH15(0x53), PABLO_13A(0x54), GORGON_CH18(0x56), RIEV_CH19_CH20(0x57), GHEB(0x5A), BERAN(0x5B),
		CYCLOPS_CH12B(0x5C), HELLBONE_CH11A(0x5D), DEATHGOYLE_CH11B(0x5E), ONEILL(0x68), GLEN_CUTSCENE(0x69),
		ZONTA(0x6A), VIGARDE(0x6B), ORSON_CH16(0x6D),
		...
		private Character(final int id) {
			ID = id;
		}
		...
		public static Set<Character> allPlayableCharacters = new HashSet<Character>(
				Arrays.asList(EIRIKA, SETH, GILLIAM, FRANZ, MOULDER, VANESSA, ROSS, NEIMI, COLM, GARCIA, INNES, LUTE,
						NATASHA, CORMAG, EPHRAIM, FORDE, KYLE, AMELIA, ARTUR, GERIK, TETHYS, MARISA, SALEH, EWAN,
						LARACHEL, DOZLA, RENNAC, DUESSEL, MYRRH, KNOLL, JOSHUA, SYRENE, TANA));

		public static Set<Character> allBossCharacters = new HashSet<Character>(Arrays.asList(ORSON, SELENA,
				SELENA_CH10B_CH13B, VALTER, VALTER_CH15, VALTER_PROLOGUE, RIEV, CAELLACH, BREGUET, BONE, BAZBA,
				MUMMY_CH4, SAAR, NOVALA, MURRAY, TIRADO, BINKS, PABLO, MACDAIRE_CH12A, AIAS, CARLYLE, CAELLACH_CH15,
				PABLO_13A, GORGON_CH18, RIEV_CH19_CH20, GHEB, BERAN, CYCLOPS_CH12B, HELLBONE_CH11A, DEATHGOYLE_CH11B,
				ONEILL, GLEN_CUTSCENE, ZONTA, VIGARDE, ORSON_CH16));
		public static Set<Character> restrictedClassCharacters = new HashSet<Character>(
				Arrays.asList(VANESSA, CORMAG, VALTER, GLEN, GLEN_CUTSCENE, VALTER_CH15, VALTER_PROLOGUE, BONE));
		...
		public static Set<Character> doNotChange = new HashSet<Character>(
				Arrays.asList(MORVA, LYON, LYON_CH17, LYON_FINAL, DEMON_KING, DARA, KLIMT, MYRRH));

		public static Set<Character> charactersThatRequireRange = new HashSet<Character>(Arrays.asList(ARTUR)); // Skippable,
																												// but
																												// Ch.4
																												// has a
																												// scripted
																												...
																												// a
																												// Mogall.
		public static Set<Character> charactersThatRequireMelee = new HashSet<Character>(Arrays.asList(SETH)); // The
																												// prologue
																												// scripted
																												// battle.

		// Vanessa isn't strictly required, but Ross is likely screwed otherwise.
		public static Set<Character> requiredFliers = new HashSet<Character>(
				Arrays.asList(VANESSA, CORMAG, VALTER, GLEN, GLEN_CUTSCENE, VALTER_CH15, VALTER_PROLOGUE));
		public static Set<Character> requiredAttackers = new HashSet<Character>(
				Arrays.asList(EIRIKA, EPHRAIM, SETH, ARTUR, GARCIA));
		public static Set<Character> femaleSet = new HashSet<Character>(Arrays.asList(EIRIKA, VANESSA, NEIMI, LUTE,
				NATASHA, AMELIA, TETHYS, MARISA, LARACHEL, MYRRH, SYRENE, TANA, SELENA, SELENA_CH10B_CH13B, ISMAIRE));
		public static Set<Character> requiresPromotion = new HashSet<Character>(Arrays.asList(EIRIKA, EPHRAIM));

		public static Set<Character> doNotBuff = new HashSet<Character>(Arrays.asList(VALTER_PROLOGUE)); // This is
																											// scripted,
																											// and Seth
																											// shouldn't
																											// die here.
		public static Set<Character> safeCreatureCampaignCharacters = new HashSet<Character>(
				Arrays.asList(FADO, GLEN, HAYDEN, ISMAIRE));
	...
	public enum CharacterClass implements GBAFEClass {
		...
		EPHRAIM_LORD(0x01), CAVALIER(0x05), KNIGHT(0x09), THIEF(0x0D), MERCENARY(0x0F), MYRMIDON(0x13), ARCHER(0x19),
		WYVERN_RIDER(0x1F), MAGE(0x25), SHAMAN(0x2D), FIGHTER(0x3F), BRIGAND(0x41), PIRATE(0x42), MONK(0x44),
		PRIEST(0x45), SOLDIER(0x4E), TRAINEE_2(0x7E), PUPIL_2(0x7F),

		EIRIKA_LORD(0x02), CAVALIER_F(0x06), KNIGHT_F(0x0A), MYRMIDON_F(0x14), ARCHER_F(0x1A), MAGE_F(0x26),
		PEGASUS_KNIGHT(0x48), CLERIC(0x4A), TROUBADOUR(0x4B), DANCER(0x4D), RECRUIT_2(0x37),

		EPHRAIM_MASTER_LORD(0x03), PALADIN(0x07), GENERAL(0x0B), HERO(0x11), SWORDMASTER(0x15), ASSASSIN(0x17),
		SNIPER(0x1B), RANGER(0x1D), WYVERN_LORD(0x21), WYVERN_KNIGHT(0x23), SAGE(0x27), MAGE_KNIGHT(0x29), BISHOP(0x2B),
		DRUID(0x2F), SUMMONER(0x31), ROGUE(0x33), GREAT_KNIGHT(0x35), SUPER_TRAINEE(0x38), SUPER_PUPIL(0x39),
		WARRIOR(0x40), BERSERKER(0x43),

		EIRIKA_MASTER_LORD(0x04), PALADIN_F(0x08), GENERAL_F(0x0C), SWORDMASTER_F(0x16), ASSASSIN_F(0x18),
		SNIPER_F(0x1C), RANGER_F(0x1E), WYVERN_KNIGHT_F(0x24), SAGE_F(0x28), MAGE_KNIGHT_F(0x2A), BISHOP_F(0x2C),
		GREAT_KNIGHT_F(0x36), SUPER_RECRUIT(0x3A), MANAKETE_F(0x3C), FALCON_KNIGHT(0x49), VALKYRIE(0x4C),

		REVENANT(0x52), BONEWALKER(0x54), BONEWALKER_BOW(0x55), BAEL(0x58), MAUTHE_DOOG(0x5B), TARVOS(0x5D),
		MOGALL(0x5F), GARGOYLE(0x63),

		ENTOMBED(0x53), WIGHT(0x56), WIGHT_BOW(0x57), ELDER_BAEL(0x59), CYCLOPS(0x5A), GWYLLGI(0x5C), MAELDUIN(0x5E),
		ARCH_MOGALL(0x60), GORGON(0x61), DEATHGOYLE(0x64), CYCLOPS_2(0x7C), ELDER_BAEL_2(0x7D),

		UNUSED_MANAKETE(0x0E), MERCENARY_F(0x10), HERO_F(0x12), WYVERN_RIDER_F(0x20), WYVERN_LORD_F(0x22),
		SHAMAN_F(0x2E), DRUID_F(0x30), SUMMONER_F(0x32), MANAKETE_2(0x3B), BARD(0x46),

		GORGON_EGG(0x34), /* GORGON_EGG_2(0x62), */ NECROMANCER(0x4F), FLEET(0x50), GHOST_FIGHTER(0x51),
		DRACOZOMBIE(0x65), DEMON_KING(0x66), UNUSED_TENT(0x79);
		...
		private CharacterClass(final int id) {
			ID = id;
		}
		...
		public static Comparator<CharacterClass> classIDComparator() {
			return new Comparator<CharacterClass>() {
		...
		public static Set<CharacterClass> allMaleClasses = new HashSet<CharacterClass>(Arrays.asList(TRAINEE, PUPIL,
				EPHRAIM_LORD, CAVALIER, KNIGHT, THIEF, MERCENARY, MYRMIDON, ARCHER, WYVERN_RIDER, MAGE, SHAMAN, FIGHTER,
				BRIGAND, PIRATE, MONK, PRIEST, SOLDIER, TRAINEE_2, PUPIL_2, EPHRAIM_MASTER_LORD, PALADIN, GENERAL, HERO,
				SWORDMASTER, ASSASSIN, SNIPER, RANGER, WYVERN_LORD, WYVERN_KNIGHT, SAGE, MAGE_KNIGHT, BISHOP, DRUID,
				SUMMONER, ROGUE, GREAT_KNIGHT, SUPER_TRAINEE, SUPER_PUPIL, WARRIOR, BERSERKER));
		public static Set<CharacterClass> allFemaleClasses = new HashSet<CharacterClass>(
				Arrays.asList(RECRUIT, EIRIKA_LORD, CAVALIER_F, KNIGHT_F, MYRMIDON_F, ARCHER_F, MAGE_F, PEGASUS_KNIGHT,
						CLERIC, TROUBADOUR, DANCER, RECRUIT_2, EIRIKA_MASTER_LORD, PALADIN_F, GENERAL_F, SWORDMASTER_F,
						ASSASSIN_F, SNIPER_F, RANGER_F, WYVERN_KNIGHT_F, SAGE_F, MAGE_KNIGHT_F, BISHOP_F,
						GREAT_KNIGHT_F, SUPER_RECRUIT, MANAKETE_F, FALCON_KNIGHT, VALKYRIE));
		public static Set<CharacterClass> allMonsterClasses = new HashSet<CharacterClass>(
				Arrays.asList(REVENANT, BONEWALKER, BONEWALKER_BOW, BAEL, MAUTHE_DOOG, TARVOS, MOGALL, GARGOYLE,
						ENTOMBED, WIGHT, WIGHT_BOW, ELDER_BAEL, CYCLOPS, GWYLLGI, MAELDUIN, ARCH_MOGALL, GORGON,
						DEATHGOYLE, CYCLOPS_2, ELDER_BAEL_2, DRACOZOMBIE));
		public static Set<CharacterClass> monsterWeaponClasses = new HashSet<CharacterClass>(Arrays.asList(REVENANT,
				BAEL, MAUTHE_DOOG, MOGALL, ENTOMBED, ELDER_BAEL, GWYLLGI, ARCH_MOGALL, GORGON, ELDER_BAEL_2));

		public static Set<CharacterClass> allLordClasses = new HashSet<CharacterClass>(
				Arrays.asList(EIRIKA_LORD, EPHRAIM_LORD, EIRIKA_MASTER_LORD, EPHRAIM_MASTER_LORD));
		public static Set<CharacterClass> allThiefClasses = new HashSet<CharacterClass>(
				Arrays.asList(THIEF, ASSASSIN, ROGUE));
		public static Set<CharacterClass> allSpecialClasses = new HashSet<CharacterClass>(
				Arrays.asList(DANCER, MANAKETE_F));

		public static Set<CharacterClass> allTraineeClasses = new HashSet<CharacterClass>(
				Arrays.asList(TRAINEE, PUPIL, RECRUIT));
		public static Set<CharacterClass> allUnpromotedClasses = new HashSet<CharacterClass>(Arrays.asList(EPHRAIM_LORD,
				CAVALIER, KNIGHT, THIEF, MERCENARY, MYRMIDON, ARCHER, WYVERN_RIDER, MAGE, SHAMAN, RECRUIT_2, FIGHTER,
				BRIGAND, PIRATE, MONK, PRIEST, SOLDIER, TRAINEE_2, PUPIL_2, EIRIKA_LORD, CAVALIER_F, KNIGHT_F,
				MYRMIDON_F, ARCHER_F, MAGE_F, PEGASUS_KNIGHT, CLERIC, TROUBADOUR, DANCER, REVENANT, BONEWALKER,
				BONEWALKER_BOW, BAEL, MAUTHE_DOOG, TARVOS, MOGALL, GARGOYLE));
		public static Set<CharacterClass> allPromotedClasses = new HashSet<CharacterClass>(Arrays.asList(
				EPHRAIM_MASTER_LORD, PALADIN, GENERAL, HERO, SWORDMASTER, ASSASSIN, SNIPER, RANGER, WYVERN_LORD,
				WYVERN_KNIGHT, SAGE, MAGE_KNIGHT, BISHOP, DRUID, SUMMONER, ROGUE, GREAT_KNIGHT, SUPER_TRAINEE,
				SUPER_PUPIL, WARRIOR, BERSERKER, EIRIKA_MASTER_LORD, PALADIN_F, GENERAL_F, SWORDMASTER_F, ASSASSIN_F,
				SNIPER_F, RANGER_F, WYVERN_KNIGHT_F, SAGE_F, MAGE_KNIGHT_F, BISHOP_F, GREAT_KNIGHT_F, SUPER_RECRUIT,
				MANAKETE_F, FALCON_KNIGHT, VALKYRIE, ENTOMBED, WIGHT, WIGHT_BOW, ELDER_BAEL, CYCLOPS, GWYLLGI, MAELDUIN,
				ARCH_MOGALL, GORGON, DEATHGOYLE, CYCLOPS_2, ELDER_BAEL_2, NECROMANCER, DRACOZOMBIE));

		public static Set<CharacterClass> allPacifistClasses = new HashSet<CharacterClass>(
				Arrays.asList(DANCER, CLERIC, TROUBADOUR, PRIEST));
		public static Set<CharacterClass> allMeleeLockedClasses = new HashSet<CharacterClass>(
				Arrays.asList(MYRMIDON, MERCENARY, EIRIKA_LORD, THIEF, MYRMIDON_F, BAEL, ELDER_BAEL, ELDER_BAEL_2,
						MAUTHE_DOOG, GWYLLGI, REVENANT, ENTOMBED));
		public static Set<CharacterClass> allRangeLockedClasses = new HashSet<CharacterClass>(
				Arrays.asList(ARCHER, ARCHER_F, SNIPER, SNIPER_F, BONEWALKER_BOW, WIGHT_BOW));

		public static Set<CharacterClass> allValidClasses = new HashSet<CharacterClass>(Arrays.asList(EPHRAIM_LORD,
				CAVALIER, KNIGHT, THIEF, MERCENARY, MYRMIDON, ARCHER, WYVERN_RIDER, MAGE, SHAMAN, FIGHTER, BRIGAND,
				PIRATE, MONK, PRIEST, SOLDIER, TRAINEE_2, PUPIL_2, EPHRAIM_MASTER_LORD, PALADIN, GENERAL, HERO,
				SWORDMASTER, ASSASSIN, SNIPER, RANGER, WYVERN_LORD, WYVERN_KNIGHT, SAGE, MAGE_KNIGHT, BISHOP, DRUID,
				SUMMONER, ROGUE, GREAT_KNIGHT, SUPER_TRAINEE, SUPER_PUPIL, WARRIOR, BERSERKER, EIRIKA_LORD, CAVALIER_F,
				KNIGHT_F, MYRMIDON_F, ARCHER_F, MAGE_F, PEGASUS_KNIGHT, CLERIC, TROUBADOUR, DANCER, RECRUIT_2,
				EIRIKA_MASTER_LORD, PALADIN_F, GENERAL_F, SWORDMASTER_F, ASSASSIN_F, SNIPER_F, RANGER_F,
				WYVERN_KNIGHT_F, SAGE_F, MAGE_KNIGHT_F, BISHOP_F, GREAT_KNIGHT_F, SUPER_RECRUIT,
				/* MANAKETE_F, */ FALCON_KNIGHT, VALKYRIE, REVENANT, BONEWALKER, BONEWALKER_BOW, BAEL, MAUTHE_DOOG,
				TARVOS, MOGALL, GARGOYLE, ENTOMBED, WIGHT, WIGHT_BOW, ELDER_BAEL, CYCLOPS, GWYLLGI, MAELDUIN,
				ARCH_MOGALL, GORGON, DEATHGOYLE, CYCLOPS_2, ELDER_BAEL_2));

		// Leaving this empty for the time being. If it turns out to be an issue when
		// hostile AI gets its hands on classes it doesn't know
		...
		public static Set<CharacterClass> flyingClasses = new HashSet<CharacterClass>(
				Arrays.asList(WYVERN_RIDER, PEGASUS_KNIGHT, MOGALL, GARGOYLE, WYVERN_LORD, WYVERN_KNIGHT,
						WYVERN_KNIGHT_F, FALCON_KNIGHT, ARCH_MOGALL, DEATHGOYLE));
		public static Set<CharacterClass> allMountedClasses = new HashSet<CharacterClass>(Arrays.asList(CAVALIER,
				CAVALIER_F, PALADIN, PALADIN_F, GREAT_KNIGHT_F, GREAT_KNIGHT, TROUBADOUR, MAGE_KNIGHT, MAGE_KNIGHT_F,
				VALKYRIE, EPHRAIM_MASTER_LORD, EIRIKA_MASTER_LORD, RANGER, RANGER_F));

		public static Set<CharacterClass> meleeOnlyClasses = new HashSet<CharacterClass>(Arrays.asList(THIEF, MERCENARY,
				MYRMIDON, SWORDMASTER, ASSASSIN, ROGUE, EIRIKA_LORD, MYRMIDON_F, MANAKETE_F, SWORDMASTER_F, ASSASSIN_F,
				REVENANT, BAEL, MAUTHE_DOOG, ENTOMBED, ELDER_BAEL, GWYLLGI, ELDER_BAEL_2));
		public static Set<CharacterClass> rangedOnlyClasses = new HashSet<CharacterClass>(
				Arrays.asList(ARCHER, SNIPER, ARCHER_F, SNIPER_F, BONEWALKER_BOW, WIGHT_BOW));
		...
		public static Set<CharacterClass> classesThatLoseToClass(CharacterClass originalClass,
				CharacterClass winningClass, Boolean excludeLords, Boolean excludeThieves) {
		...
		public static Set<CharacterClass> targetClassesForRandomization(CharacterClass sourceClass, boolean isForEnemy,
				Boolean excludeSource, Boolean excludeLords, Boolean excludeThieves, Boolean excludeSpecial,
				Boolean separateMonsterClasses, Boolean requireAttack, Boolean requiresRange, Boolean requiresMelee,
				Boolean applyRestrictions, Boolean restrictGender) {
			Set<CharacterClass> limited = limitedClassesForRandomization(sourceClass, separateMonsterClasses,
					requiresRange, requiresMelee);
		...
		private static Set<CharacterClass> limitedClassesForRandomization(CharacterClass sourceClass,
				Boolean separateMonsters, Boolean requireRange, Boolean requireMelee) {
			if (separateMonsters) {
				switch (sourceClass) {
				case WYVERN_RIDER:
				case PEGASUS_KNIGHT:
				...
				case FALCON_KNIGHT:
					return new HashSet<CharacterClass>(
							Arrays.asList(WYVERN_LORD, WYVERN_KNIGHT, WYVERN_KNIGHT_F, FALCON_KNIGHT));
				case GARGOYLE:
				case MOGALL:
				...
				case ELDER_BAEL_2:
					return new HashSet<CharacterClass>(
							Arrays.asList(ELDER_BAEL, ELDER_BAEL_2, ARCH_MOGALL, DEATHGOYLE));
				case BERSERKER:
					return new HashSet<CharacterClass>(
							Arrays.asList(BERSERKER, WYVERN_LORD, WYVERN_KNIGHT, WYVERN_KNIGHT_F, FALCON_KNIGHT));
				default:
					return null;
				}
			} else {
				...
				case DEATHGOYLE:
				case ARCH_MOGALL:
					return new HashSet<CharacterClass>(Arrays.asList(WYVERN_LORD, WYVERN_KNIGHT, WYVERN_KNIGHT_F,
							FALCON_KNIGHT, DEATHGOYLE, ARCH_MOGALL));
				case PIRATE:
					return new HashSet<CharacterClass>(
							Arrays.asList(PIRATE, WYVERN_RIDER, PEGASUS_KNIGHT, GARGOYLE, MOGALL));
				case BRIGAND:
				case BAEL:
					if (requireRange) {
						return new HashSet<CharacterClass>(
								Arrays.asList(BRIGAND, WYVERN_RIDER, PEGASUS_KNIGHT, MOGALL, GARGOYLE));
					} else {
						return new HashSet<CharacterClass>(
								Arrays.asList(BRIGAND, WYVERN_RIDER, PEGASUS_KNIGHT, BAEL, MOGALL, GARGOYLE));
					}
				case ELDER_BAEL:
				case ELDER_BAEL_2:
				case BERSERKER:
					if (requireRange) {
						return new HashSet<CharacterClass>(Arrays.asList(BERSERKER, WYVERN_LORD, WYVERN_KNIGHT,
								WYVERN_KNIGHT_F, FALCON_KNIGHT, ARCH_MOGALL, DEATHGOYLE));
					} else {
						return new HashSet<CharacterClass>(Arrays.asList(BERSERKER, WYVERN_LORD, WYVERN_KNIGHT,
								WYVERN_KNIGHT_F, FALCON_KNIGHT, ELDER_BAEL, ELDER_BAEL_2, ARCH_MOGALL, DEATHGOYLE));
					}
				default:
					return null;
				}
	...
	public enum Item implements GBAFEItem {
		...
		IRON_SWORD(0x01), SLIM_SWORD(0x02), STEEL_SWORD(0x03), SILVER_SWORD(0x04), IRON_BLADE(0x05), STEEL_BLADE(0x06),
		SILVER_BLADE(0x07), POISON_SWORD(0x08), RAPIER(0x09), BRAVE_SWORD(0x0B), SHAMSHIR(0x0C), KILLING_EDGE(0x0D),
		ARMORSLAYER(0x0E), WYRMSLAYER(0x0F), LIGHT_BRAND(0x10), RUNE_SWORD(0x11), LANCEREAVER(0x12), ZANBATO(0x13),
		SHADOWKILLER(0x81), SIEGLINDE(0x85), AUDHULMA(0x91), WIND_SWORD(0xA1),

		IRON_LANCE(0x14), SLIM_LANCE(0x15), STEEL_LANCE(0x16), SILVER_LANCE(0x17), TOXIN_LANCE(0x18), BRAVE_LANCE(0x19),
		KILLER_LANCE(0x1A), HORSESLAYER(0x1B), JAVELIN(0x1C), SPEAR(0x1D), AXEREAVER(0x1E), REGINLEIF(0x78),
		BRIGHT_LANCE(0x82), DRAGONSPEAR(0x8D), VIDOFNIR(0x8E), SIEGMUND(0x92), HEAVY_SPEAR(0x95), SHORT_SPEAR(0x96),

		IRON_AXE(0x1F), STEEL_AXE(0x20), SILVER_AXE(0x21), POISON_AXE(0x22), BRAVE_AXE(0x23), KILLER_AXE(0x24),
		HALBERD(0x25), HAMMER(0x26), DEVIL_AXE(0x27), HAND_AXE(0x28), TOMAHAWK(0x29), SWORDREAVER(0x2A),
		SWORDSLAYER(0x2B), HATCHET(0x2C), DRAGON_AXE(0x5A), FIENDCLEAVER(0x83), BATTLE_AXE(0x86), GARM(0x93),

		IRON_BOW(0x2D), STEEL_BOW(0x2E), SILVER_BOW(0x2F), POISON_BOW(0x30), KILLER_BOW(0x31), BRAVE_BOW(0x32),
		SHORT_BOW(0x33), LONG_BOW(0x34), BEACON_BOW(0x84), NIDHOGG(0x94),
		...
		SHARP_CLAW(0x8B), WRETCHED_AIR(0x90), DRAGONSTONE(0xAA), DEMON_SURGE(0xAB), SHADOWSHOT(0xAC), ROTTEN_CLAW(0xAD),
		FETID_CLAW(0xAE), POISON_CLAW(0xAF), LETHAL_TALON(0xB0), FIERY_FANG(0xB1), HELLFANG(0xB2), EVIL_EYE(0xB3),
		CRIMSON_EYE(0xB4), STONE(0xB5),

		ANGELIC_ROBE(0x5B), ENERGY_RING(0x5C), SECRET_BOOK(0x5D), SPEEDWINGS(0x5E), GODDESS_ICON(0x5F),
		DRAGONSHIELD(0x60), TALISMAN(0x61), BOOTS(0x62), BODY_RING(0x63),

		HERO_CREST(0x64), KNIGHT_CREST(0x65), ORION_BOLT(0x66), ELYSIAN_WHIP(0x67), GUIDING_RING(0x68),
		MASTER_SEAL(0x88), CONQUORER_PROOF(0x97), MOON_BRACELET(0x98), SUN_BRACELET(0x99), HEAVEN_SEAL(0x8A), // We're
																												// going
																												// to
																												// recycle
																												// this
		...
		GOLD_1(0x77), GOLD_1_AGAIN(0x9A), GOLD_5(0x9B), GOLD_10(0x9C), GOLD_50(0x9D), GOLD_100(0x9E), GOLD_3000(0x9F),
		GOLD_5000(0xA0),
		...
		public enum FE8WeaponRank {
			...
			private FE8WeaponRank(final int value) {
				this.value = value;
			}
		...
		public enum FE8WeaponType {
			...
			private FE8WeaponType(final int id) {
				ID = id;
			}
		...
		public enum Ability1Mask {
			NONE(0x00), WEAPON(0x01), MAGIC(0x02), STAFF(0x04), UNBREAKABLE(0x08), UNSELLABLE(0x10), BRAVE(0x20),
			MAGIC_DAMAGE(0x40), UNCOUNTERABLE(0x80);
			...
			private Ability1Mask(final int id) {
				ID = id;
			}
			...
			public static String stringOfActiveAbilities(int abilityValue, String delimiter) {
				...
				for (Ability1Mask mask : Ability1Mask.values()) {
					if ((abilityValue & mask.ID) != 0) {
						strings.add(WhyDoesJavaNotHaveThese.stringByCapitalizingFirstLetter(mask.toString()));
					}
				}
		...
		public enum Ability2Mask {
			...
			private Ability2Mask(final int id) {
				ID = id;
			}
		...
		public enum Ability3Mask {
			...
			private Ability3Mask(final int id) {
				ID = id;
			}
		...
		public enum WeaponEffect {
			...
			private WeaponEffect(final int id) {
				ID = id;
			}
			...
			public static String stringOfActiveEffect(int effectValue) {
				for (WeaponEffect effect : WeaponEffect.values()) {
					if (effectValue == effect.ID) {
						return WhyDoesJavaNotHaveThese.stringByCapitalizingFirstLetter(effect.toString());
					}
				}
		...
		public static Set<Item> allSwords = new HashSet<Item>(
				Arrays.asList(IRON_SWORD, SLIM_SWORD, STEEL_SWORD, SILVER_SWORD, IRON_BLADE, STEEL_BLADE, SILVER_BLADE,
						POISON_SWORD, RAPIER, BRAVE_SWORD, SHAMSHIR, KILLING_EDGE, ARMORSLAYER, WYRMSLAYER, LIGHT_BRAND,
						RUNE_SWORD, LANCEREAVER, ZANBATO, SHADOWKILLER, SIEGLINDE, AUDHULMA, WIND_SWORD));
		public static Set<Item> allLances = new HashSet<Item>(Arrays.asList(IRON_LANCE, SLIM_LANCE, STEEL_LANCE,
				SILVER_LANCE, TOXIN_LANCE, BRAVE_LANCE, KILLER_LANCE, HORSESLAYER, JAVELIN, SPEAR, AXEREAVER, REGINLEIF,
				BRIGHT_LANCE, DRAGONSPEAR, VIDOFNIR, SIEGMUND, HEAVY_SPEAR, SHORT_SPEAR));
		public static Set<Item> allAxes = new HashSet<Item>(Arrays.asList(IRON_AXE, STEEL_AXE, SILVER_AXE, POISON_AXE,
				BRAVE_AXE, KILLER_AXE, HALBERD, HAMMER, DEVIL_AXE, HAND_AXE, TOMAHAWK, SWORDREAVER, SWORDSLAYER,
				HATCHET, DRAGON_AXE, FIENDCLEAVER, BATTLE_AXE, GARM));
		public static Set<Item> allBows = new HashSet<Item>(Arrays.asList(IRON_BOW, STEEL_BOW, SILVER_BOW, POISON_BOW,
				KILLER_BOW, BRAVE_BOW, SHORT_BOW, LONG_BOW, BEACON_BOW, NIDHOGG));
		public static Set<Item> allAnima = new HashSet<Item>(
				Arrays.asList(FIRE, THUNDER, ELFIRE, BOLTING, FIMBULVETR, EXCALIBUR));
		public static Set<Item> allLight = new HashSet<Item>(
				Arrays.asList(LIGHTNING, SHINE, DIVINE, PURGE, AURA, IVALDI));
		public static Set<Item> allDark = new HashSet<Item>(
				Arrays.asList(FLUX, LUNA, NOSFERATU, ECLIPSE, FENRIR, GLEIPNIR, NAGLFAR));
		public static Set<Item> allMonsterWeapons = new HashSet<Item>(
				Arrays.asList(SHARP_CLAW, WRETCHED_AIR, DRAGONSTONE, DEMON_SURGE, SHADOWSHOT, ROTTEN_CLAW, FETID_CLAW,
						POISON_CLAW, LETHAL_TALON, FIERY_FANG, HELLFANG, EVIL_EYE, CRIMSON_EYE, STONE));

		public static Set<Item> allHealingStaves = new HashSet<Item>(
				Arrays.asList(HEAL, MEND, RECOVER, PHYSIC, FORTIFY, LATONA));
		public static Set<Item> allSupportStaves = new HashSet<Item>(
				Arrays.asList(RESTORE, WARP, RESCUE, TORCH_STAFF, HAMMERNE, UNLOCK, BARRIER));
		public static Set<Item> allStatusStaves = new HashSet<Item>(Arrays.asList(SILENCE, SLEEP, BERSERK));
		public static Set<Item> allStatBoosters = new HashSet<Item>(Arrays.asList(ANGELIC_ROBE, ENERGY_RING,
				SECRET_BOOK, SPEEDWINGS, GODDESS_ICON, DRAGONSHIELD, TALISMAN, BOOTS, BODY_RING));
		public static Set<Item> allPromotionItems = new HashSet<Item>(
				Arrays.asList(HERO_CREST, KNIGHT_CREST, ORION_BOLT, ELYSIAN_WHIP, GUIDING_RING));
		public static Set<Item> allSpecialItems = new HashSet<Item>(
				Arrays.asList(FILI_SHIELD, MEMBER_CARD, HOPLON_GUARD, SILVER_CARD, METIS_TOME));
		public static Set<Item> allMoneyItems = new HashSet<Item>(
				Arrays.asList(WHITE_GEM, BLUE_GEM, RED_GEM, BLACK_GEM, GOLD_GEM));
		public static Set<Item> usableItems = new HashSet<Item>(Arrays.asList(CHEST_KEY, CHEST_KEY_5, DOOR_KEY,
				LOCKPICK, VULNERARY, ELIXIR, PURE_WATER, ANTITOXIN, TORCH));

		public static Set<Item> allPotentialRewards = new HashSet<Item>(Arrays.asList(
				/* IRON_SWORD, SLIM_SWORD, */ STEEL_SWORD, SILVER_SWORD, IRON_BLADE, STEEL_BLADE, SILVER_BLADE,
				POISON_SWORD, RAPIER, BRAVE_SWORD, SHAMSHIR, KILLING_EDGE, ARMORSLAYER, WYRMSLAYER, LIGHT_BRAND,
				RUNE_SWORD, LANCEREAVER, ZANBATO, SHADOWKILLER, WIND_SWORD, /* IRON_LANCE, SLIM_LANCE, */ STEEL_LANCE,
				SILVER_LANCE, /* TOXIN_LANCE, */ BRAVE_LANCE, KILLER_LANCE, HORSESLAYER, JAVELIN, SPEAR, AXEREAVER,
				REGINLEIF, BRIGHT_LANCE, DRAGONSPEAR, HEAVY_SPEAR, SHORT_SPEAR, /* IRON_AXE, */ STEEL_AXE, SILVER_AXE,
				/* POISON_AXE, */ BRAVE_AXE, KILLER_AXE, HALBERD, HAMMER, DEVIL_AXE, HAND_AXE, TOMAHAWK, SWORDREAVER,
				SWORDSLAYER, HATCHET, DRAGON_AXE, FIENDCLEAVER, BATTLE_AXE, /* IRON_BOW, */ STEEL_BOW, SILVER_BOW,
				/* POISON_BOW, */ KILLER_BOW, BRAVE_BOW, SHORT_BOW, LONG_BOW, BEACON_BOW, /* FIRE, */ THUNDER, ELFIRE,
				BOLTING, FIMBULVETR, /* LIGHTNING, */ SHINE, DIVINE, PURGE, AURA, /* FLUX, */ LUNA, NOSFERATU, ECLIPSE,
				FENRIR, /* HEAL, */ MEND, RECOVER, PHYSIC, FORTIFY, RESTORE, WARP, RESCUE, TORCH_STAFF, HAMMERNE,
				UNLOCK, BARRIER, SILENCE, SLEEP, BERSERK, ANGELIC_ROBE, ENERGY_RING, SECRET_BOOK, SPEEDWINGS,
				GODDESS_ICON, DRAGONSHIELD, TALISMAN, BOOTS, BODY_RING, HERO_CREST, KNIGHT_CREST, ORION_BOLT,
				ELYSIAN_WHIP, GUIDING_RING, FILI_SHIELD, MEMBER_CARD, HOPLON_GUARD, SILVER_CARD, METIS_TOME, WHITE_GEM,
				BLUE_GEM, RED_GEM, BLACK_GEM, GOLD_GEM, CHEST_KEY, CHEST_KEY_5, DOOR_KEY, LOCKPICK, VULNERARY, ELIXIR,
				PURE_WATER, ANTITOXIN, TORCH));

		public static Set<Item> commonDrops = new HashSet<Item>(
				Arrays.asList(VULNERARY, ELIXIR, ANTITOXIN, PURE_WATER, TORCH, CHEST_KEY, DOOR_KEY, RED_GEM));
		...
		public static Set<Item> rareDrops = new HashSet<Item>(Arrays.asList(ANGELIC_ROBE, ENERGY_RING, SECRET_BOOK,
				SPEEDWINGS, GODDESS_ICON, DRAGONSHIELD, TALISMAN, BOOTS, BODY_RING, WHITE_GEM));

		public static Set<Item> allWeapons = new HashSet<Item>(Arrays.asList(IRON_SWORD, SLIM_SWORD, STEEL_SWORD,
				SILVER_SWORD, IRON_BLADE, STEEL_BLADE, SILVER_BLADE, POISON_SWORD, RAPIER, BRAVE_SWORD, SHAMSHIR,
				KILLING_EDGE, ARMORSLAYER, WYRMSLAYER, LIGHT_BRAND, RUNE_SWORD, LANCEREAVER, ZANBATO, SHADOWKILLER,
				SIEGLINDE, AUDHULMA, WIND_SWORD, IRON_LANCE, SLIM_LANCE, STEEL_LANCE, SILVER_LANCE, TOXIN_LANCE,
				BRAVE_LANCE, KILLER_LANCE, HORSESLAYER, JAVELIN, SPEAR, AXEREAVER, REGINLEIF, BRIGHT_LANCE, DRAGONSPEAR,
				VIDOFNIR, SIEGMUND, HEAVY_SPEAR, SHORT_SPEAR, IRON_AXE, STEEL_AXE, SILVER_AXE, POISON_AXE, BRAVE_AXE,
				KILLER_AXE, HALBERD, HAMMER, DEVIL_AXE, HAND_AXE, TOMAHAWK, SWORDREAVER, SWORDSLAYER, HATCHET,
				DRAGON_AXE, FIENDCLEAVER, BATTLE_AXE, GARM, IRON_BOW, STEEL_BOW, SILVER_BOW, POISON_BOW, KILLER_BOW,
				BRAVE_BOW, SHORT_BOW, LONG_BOW, BEACON_BOW, NIDHOGG, FIRE, THUNDER, ELFIRE, BOLTING, FIMBULVETR,
				EXCALIBUR, LIGHTNING, SHINE, DIVINE, PURGE, AURA, IVALDI, FLUX, LUNA, NOSFERATU, ECLIPSE, FENRIR,
				GLEIPNIR, NAGLFAR, SHARP_CLAW, WRETCHED_AIR, DRAGONSTONE, DEMON_SURGE, SHADOWSHOT, ROTTEN_CLAW,
				FETID_CLAW, POISON_CLAW, LETHAL_TALON, FIERY_FANG, HELLFANG, EVIL_EYE, CRIMSON_EYE, STONE));
		public static Set<Item> allRangedWeapons = new HashSet<Item>(Arrays.asList(LIGHT_BRAND, RUNE_SWORD, WIND_SWORD,
				JAVELIN, SPEAR, SHORT_SPEAR, HAND_AXE, TOMAHAWK, IRON_BOW, STEEL_BOW, SILVER_BOW, POISON_BOW,
				KILLER_BOW, BRAVE_BOW, SHORT_BOW, LONG_BOW, BEACON_BOW, NIDHOGG, FIRE, THUNDER, ELFIRE, FIMBULVETR,
				EXCALIBUR, LIGHTNING, SHINE, DIVINE, AURA, IVALDI, FLUX, LUNA, NOSFERATU, FENRIR, GLEIPNIR, NAGLFAR,
				WRETCHED_AIR, DEMON_SURGE, EVIL_EYE, CRIMSON_EYE));
		public static Set<Item> allRangedOnlyWeapons = new HashSet<Item>(Arrays.asList(IRON_BOW, STEEL_BOW, SILVER_BOW,
				POISON_BOW, KILLER_BOW, BRAVE_BOW, SHORT_BOW, LONG_BOW, BEACON_BOW, NIDHOGG));
		public static Set<Item> allStaves = new HashSet<Item>(Arrays.asList(HEAL, MEND, RECOVER, PHYSIC, FORTIFY,
				RESTORE, WARP, RESCUE, TORCH_STAFF, HAMMERNE, UNLOCK, BARRIER, SILENCE, SLEEP, BERSERK));

		public static Set<Item> allSiegeTomes = new HashSet<Item>(Arrays.asList(BOLTING, PURGE, ECLIPSE, SHADOWSHOT));

		public static Set<Item> allERank = new HashSet<Item>(Arrays.asList(IRON_SWORD, SLIM_SWORD, SHADOWKILLER,
				IRON_LANCE, SLIM_LANCE, TOXIN_LANCE, JAVELIN, BRIGHT_LANCE, IRON_AXE, STEEL_AXE, DEVIL_AXE, HAND_AXE,
				HATCHET, FIENDCLEAVER, IRON_BOW, BEACON_BOW, HEAL, FIRE, LIGHTNING));
		public static Set<Item> allDRank = new HashSet<Item>(Arrays.asList(STEEL_SWORD, IRON_BLADE, POISON_SWORD,
				SHAMSHIR, ARMORSLAYER, ZANBATO, STEEL_LANCE, HORSESLAYER, HEAVY_SPEAR, POISON_AXE, HALBERD, HAMMER,
				STEEL_BOW, POISON_BOW, SHORT_BOW, LONG_BOW, MEND, TORCH_STAFF, UNLOCK, THUNDER, SHINE, FLUX));
		public static Set<Item> allCRank = new HashSet<Item>(
				Arrays.asList(STEEL_BLADE, KILLING_EDGE, WYRMSLAYER, LIGHT_BRAND, LANCEREAVER, KILLER_LANCE, AXEREAVER,
						DRAGONSPEAR, SHORT_SPEAR, KILLER_AXE, SWORDREAVER, SWORDSLAYER, DRAGON_AXE, KILLER_BOW, RECOVER,
						RESTORE, SLEEP, HAMMERNE, BARRIER, ELFIRE, DIVINE, LUNA, NOSFERATU));
		public static Set<Item> allBRank = new HashSet<Item>(Arrays.asList(BRAVE_SWORD, WIND_SWORD, BRAVE_LANCE, SPEAR,
				BRAVE_AXE, BATTLE_AXE, BRAVE_BOW, PHYSIC, SILENCE, BERSERK, RESCUE, BOLTING, PURGE, ECLIPSE));
		public static Set<Item> allARank = new HashSet<Item>(Arrays.asList(SILVER_SWORD, SILVER_BLADE, RUNE_SWORD,
				SILVER_LANCE, SILVER_AXE, TOMAHAWK, SILVER_BOW, FORTIFY, WARP, FIMBULVETR, AURA, FENRIR));
		public static Set<Item> allSRank = new HashSet<Item>(
				Arrays.asList(AUDHULMA, VIDOFNIR, GARM, NIDHOGG, LATONA, EXCALIBUR, IVALDI, GLEIPNIR, NAGLFAR));
		public static Set<Item> allPrfRank = new HashSet<Item>(Arrays.asList(REGINLEIF, RAPIER, SIEGMUND, SIEGLINDE));

		public static Set<Item> normalSet = new HashSet<Item>(
				Arrays.asList(IRON_SWORD, SLIM_SWORD, STEEL_SWORD, SILVER_SWORD, IRON_BLADE, STEEL_BLADE, SILVER_BLADE,
						IRON_LANCE, SLIM_LANCE, STEEL_LANCE, SILVER_LANCE, IRON_AXE, STEEL_AXE, SILVER_AXE, BATTLE_AXE,
						IRON_BOW, STEEL_BOW, SILVER_BOW, SHORT_BOW, BEACON_BOW, FIRE, THUNDER, ELFIRE, FIMBULVETR,
						LIGHTNING, SHINE, DIVINE, AURA, FLUX, FENRIR, SHARP_CLAW, WRETCHED_AIR, DRAGONSTONE,
						DEMON_SURGE, ROTTEN_CLAW, FETID_CLAW, FIERY_FANG, HELLFANG, EVIL_EYE, CRIMSON_EYE));
		public static Set<Item> interestingSet = new HashSet<Item>(Arrays.asList(POISON_SWORD, RAPIER, BRAVE_SWORD,
				SHAMSHIR, KILLING_EDGE, ARMORSLAYER, WYRMSLAYER, LIGHT_BRAND, RUNE_SWORD, LANCEREAVER, ZANBATO,
				SHADOWKILLER, WIND_SWORD, TOXIN_LANCE, BRAVE_LANCE, KILLER_LANCE, HORSESLAYER, JAVELIN, SPEAR,
				AXEREAVER, REGINLEIF, BRIGHT_LANCE, DRAGONSPEAR, HEAVY_SPEAR, SHORT_SPEAR, POISON_AXE, BRAVE_AXE,
				KILLER_AXE, HALBERD, HAMMER, DEVIL_AXE, HAND_AXE, TOMAHAWK, SWORDREAVER, SWORDSLAYER, HATCHET,
				DRAGON_AXE, FIENDCLEAVER, POISON_BOW, KILLER_BOW, BRAVE_BOW, LONG_BOW, BEACON_BOW, THUNDER, BOLTING,
				SHINE, PURGE, LUNA, NOSFERATU, ECLIPSE, SHADOWSHOT, POISON_CLAW, LETHAL_TALON, STONE));
		public static Set<Item> promoSet = new HashSet<Item>(
				Arrays.asList(SHADOWKILLER, BRIGHT_LANCE, FIENDCLEAVER, BEACON_BOW));

		// These must be of lower rank than the siege tomes set, and each weapon type
		// needs to have an equivalent analogue.
		public static Set<Item> siegeReplacementSet = new HashSet<Item>(
				Arrays.asList(NOSFERATU, DIVINE, ELFIRE, DEMON_SURGE));

		public static Set<Item> killerSet = new HashSet<Item>(
				Arrays.asList(KILLING_EDGE, SHAMSHIR, KILLER_LANCE, KILLER_AXE, KILLER_BOW));
		public static Set<Item> effectiveSet = new HashSet<Item>(Arrays.asList(RAPIER, ARMORSLAYER, WYRMSLAYER, ZANBATO,
				SHADOWKILLER, HORSESLAYER, REGINLEIF, BRIGHT_LANCE, DRAGONSPEAR, HEAVY_SPEAR, HALBERD, HAMMER,
				SWORDSLAYER, DRAGON_AXE, FIENDCLEAVER, BEACON_BOW));
		public static Set<Item> poisonSet = new HashSet<Item>(
				Arrays.asList(POISON_SWORD, POISON_AXE, TOXIN_LANCE, POISON_BOW, POISON_CLAW, LETHAL_TALON));
		public static Set<Item> rangedSet = new HashSet<Item>(
				Arrays.asList(LIGHT_BRAND, RUNE_SWORD, WIND_SWORD, JAVELIN, SPEAR, SHORT_SPEAR, HAND_AXE, TOMAHAWK,
						HATCHET, LONG_BOW, BOLTING, PURGE, ECLIPSE, SHADOWSHOT));
		public static Set<Item> reaverSet = new HashSet<Item>(
				Arrays.asList(LANCEREAVER, AXEREAVER, SWORDREAVER, SWORDSLAYER));
		public static Set<Item> braveSet = new HashSet<Item>(
				Arrays.asList(BRAVE_SWORD, BRAVE_LANCE, BRAVE_AXE, BRAVE_BOW));

		public static Set<Item> allRestrictedWeapons = new HashSet<Item>(Arrays.asList(SHAMSHIR));

		public static Set<Item> allBasicWeapons = new HashSet<Item>(Arrays.asList(IRON_SWORD, IRON_LANCE, IRON_AXE,
				IRON_BOW, FIRE, LIGHTNING, FLUX, ROTTEN_CLAW, FIERY_FANG, EVIL_EYE));
		public static Set<Item> allSteelWeapons = new HashSet<Item>(
				Arrays.asList(STEEL_SWORD, STEEL_LANCE, STEEL_AXE, STEEL_BOW, THUNDER));
		...
		public static Set<Item> specialClassKit(int classID, Random rng) {
			if (classID == FE8Data.CharacterClass.DANCER.ID) {
				...
				if (random == 0) {
					new HashSet<Item>(Arrays.asList(ROTTEN_CLAW));
				} else if (random == 1) {
					new HashSet<Item>(Arrays.asList(LETHAL_TALON));
				} else {
					new HashSet<Item>(Arrays.asList(POISON_CLAW));
				}
			} else if (classID == FE8Data.CharacterClass.ENTOMBED.ID || classID == FE8Data.CharacterClass.ELDER_BAEL.ID
					|| classID == FE8Data.CharacterClass.ELDER_BAEL_2.ID) {
				int random = rng.nextInt(2);
				if (random == 0) {
					new HashSet<Item>(Arrays.asList(FETID_CLAW));
				} else {
					return new HashSet<Item>(Arrays.asList(SHARP_CLAW));
				}
				...
				int random = rng.nextInt(3);
				if (random == 0) {
					return new HashSet<Item>(Arrays.asList(CRIMSON_EYE, SHADOWSHOT));
				} else {
					return new HashSet<Item>(Arrays.asList(CRIMSON_EYE));
				}
				...
				if (random == 0) {
					...
					return new HashSet<Item>(Arrays.asList(DEMON_SURGE, STONE));
				} else if (random == 2) {
					return new HashSet<Item>(Arrays.asList(DEMON_SURGE, SHADOWSHOT));
				} else {
					return new HashSet<Item>(Arrays.asList(DEMON_SURGE));
				}
		...
		public static Set<Item> prfWeaponsForClassID(int classID) {
			if (classID == FE8Data.CharacterClass.EIRIKA_LORD.ID
					|| classID == FE8Data.CharacterClass.EIRIKA_MASTER_LORD.ID) {
				return new HashSet<Item>(Arrays.asList(RAPIER));
			} else if (classID == FE8Data.CharacterClass.EPHRAIM_LORD.ID
					|| classID == FE8Data.CharacterClass.EPHRAIM_MASTER_LORD.ID) {
		...
		public static Set<Item> lockedWeaponsToClassID(int classID) {
			if (classID == FE8Data.CharacterClass.MYRMIDON.ID || classID == FE8Data.CharacterClass.MYRMIDON_F.ID
					|| classID == FE8Data.CharacterClass.SWORDMASTER.ID
					|| classID == FE8Data.CharacterClass.SWORDMASTER_F.ID
					|| classID == FE8Data.CharacterClass.ASSASSIN.ID || classID == FE8Data.CharacterClass.ASSASSIN_F.ID
					|| classID == FE8Data.CharacterClass.EIRIKA_LORD.ID
					|| classID == FE8Data.CharacterClass.EIRIKA_MASTER_LORD.ID) {
		...
		public static Item equivalentMonsterWeapon(int baseItemID, int userClassID) {
			...
			if (!CharacterClass.allMonsterClasses.contains(userClass)) {
				return baseItem;
			}
			...
			case ELDER_BAEL:
			case ELDER_BAEL_2:
				if (allERank.contains(baseItem)) {
					return POISON_CLAW;
				} else if (allDRank.contains(baseItem)) {
					return ROTTEN_CLAW;
				} else if (allCRank.contains(baseItem)) {
					return LETHAL_TALON;
				} else if (allBRank.contains(baseItem)) {
					return FETID_CLAW;
				} else {
					return SHARP_CLAW;
				}
			case MOGALL:
			case ARCH_MOGALL:
				if (allERank.contains(baseItem) || allDRank.contains(baseItem) || allCRank.contains(baseItem)) {
					return EVIL_EYE;
				} else {
					return CRIMSON_EYE;
				}
		...
		public static Set<Item> weaponsOfTypeAndRank(WeaponType type, WeaponRank min, WeaponRank max,
				Boolean requiresRange, Boolean requiresMelee) {
			...
			list.remove(SHAMSHIR); // This one is special. It must be added in only if we're certain the class
									// asking for the item can use it.
		...
		public WeaponType getType() {
			...
			if (allLances.contains(this)) {
				return WeaponType.LANCE;
			}
			if (allAxes.contains(this)) {
				return WeaponType.AXE;
			}
			if (allBows.contains(this)) {
				return WeaponType.BOW;
			}
			if (allAnima.contains(this)) {
				return WeaponType.ANIMA;
			}
			if (allLight.contains(this)) {
				return WeaponType.LIGHT;
			}
			if (allDark.contains(this)) {
				return WeaponType.DARK;
			}
			if (allStaves.contains(this)) {
				return WeaponType.STAFF;
			}
		...
		public WeaponRank getRank() {
			if (allSRank.contains(this)) {
				return WeaponRank.S;
			}
			if (allARank.contains(this)) {
				return WeaponRank.A;
			}
			if (allBRank.contains(this)) {
				return WeaponRank.B;
			}
			if (allCRank.contains(this)) {
				return WeaponRank.C;
			}
			if (allDRank.contains(this)) {
				return WeaponRank.D;
			}
			if (allERank.contains(this)) {
				return WeaponRank.E;
			}
	...
	public enum ChapterMetadata implements GBAFEChapterMetadataChapter {
		...
		PROLOGUE_THE_FALL_OF_RENAIS(0x0), CHAPTER_1_ESCAPE(0x1), CHAPTER_2_THE_PROTECTED(0x2),
		CHAPTER_3_THE_BANDITS_OF_BORGO(0x3), CHAPTER_4_ANCIENT_HORRORS(0x4), CHAPTER_5X_UNBROKEN_HEART(0x5),
		CHAPTER_5_THE_EMPIRES_REACH(0x6), CHAPTER_6_VICTIMS_OF_WAR(0x7), CHAPTER_7_WATERSIDE_RENVALL(0x8),
		CHAPTER_8_ITS_A_TRAP(0x9), CHAPTER_9_EIRIKA_DISTANT_BLADE(0xA), CHAPTER_10_EIRIKA_REVOLT_AT_CARCINO(0xB),
		CHAPTER_12_EIRIKA_VILLAGE_OF_SILENCE(0xC), CHAPTER_13_EIRIKA_HAMILL_CANYON(0xD),
		CHAPTER_14_EIRIKA_QUEEN_OF_WHITE_DUNES(0xE), CHAPTER_15_EIRIKA_SCORCHED_SAND(0xF),
		CHAPTER_16_EIRIKA_RULED_BY_MADNESS(0x10), CHAPTER_17_EIRIKA_RIVER_OF_REGRETS(0x11),
		CHAPTER_18_EIRIKA_TWO_FACES_OF_EVIL(0x12), CHAPTER_19_EIRIKA_LAST_HOPE(0x13),
		CHAPTER_20_EIRIKA_DARKLING_WOODS(0x14), FINAL_EIRIKA_SACRED_STONE_1(0x15), FINAL_EIRIKA_SACRED_STONE_2(0x16),

		CHAPTER_9_EPHRAIM_FORT_RIGWALD(0x17), CHAPTER_10_EPHRAIM_TURNING_TRAITOR(0x18),
		CHAPTER_12_EPHRAIM_LANDING_AT_TAIZEL(0x19), CHAPTER_13_EPHRAIM_FLUORSPARS_OATH(0x1A),
		CHAPTER_14_EPHRAIM_FATHER_AND_SON(0x1B), CHAPTER_15_EPHRAIM_SCORCHED_SAND(0x1C),
		CHAPTER_16_EPHRAIM_RULED_BY_MADNESS(0x1D), CHAPTER_17_EPHRAIM_RIVER_OF_REGRETS(0x1E),
		CHAPTER_18_EPHRAIM_TWO_FACES_OF_EVIL(0x1F), CHAPTER_19_EPHRAIM_LAST_HOPE(0x20),
		CHAPTER_20_EPHRAIM_DARKLING_WOODS(0x21), FINAL_EPHRAIM_SACRED_STONE_1(0x22), FINAL_EPHRAIM_SACRED_STONE_2(0x23),

		TOWER_OF_VALNI_1(0x24), TOWER_OF_VALNI_2(0x25), TOWER_OF_VALNI_3(0x26), TOWER_OF_VALNI_4(0x27),
		TOWER_OF_VALNI_5(0x28), TOWER_OF_VALNI_6(0x29), TOWER_OF_VALNI_7(0x2A), TOWER_OF_VALNI_8(0x2B),
		TOWER_OF_VALNI_9(0x2C), // I think?
		TOWER_OF_VALNI_10(0x2D), // I think?

		LAGDOU_RUINS_1(0x2E), LAGDOU_RUINS_2(0x2F), LAGDOU_RUINS_3(0x30), LAGDOU_RUINS_4(0x31), LAGDOU_RUINS_5(0x32),
		LAGDOU_RUINS_6(0x33), LAGDOU_RUINS_7(0x34), LAGDOU_RUINS_8(0x35), LAGDOU_RUINS_9(0x36), LAGDOU_RUINS_10(0x37),

		MELKAEN_COAST(0x39),

		CHAPTER_11_EIRIKA_CREEPING_DARKNESS(0x3D), CHAPTER_11_EPHRAIM_PHANTOM_SHIP(0x3E);
		...
		public static ChapterMetadata[] orderedChapters() {
			return new ChapterMetadata[] { PROLOGUE_THE_FALL_OF_RENAIS, CHAPTER_1_ESCAPE, CHAPTER_2_THE_PROTECTED,
					CHAPTER_3_THE_BANDITS_OF_BORGO, CHAPTER_4_ANCIENT_HORRORS, CHAPTER_5_THE_EMPIRES_REACH,
					CHAPTER_5X_UNBROKEN_HEART, CHAPTER_6_VICTIMS_OF_WAR, CHAPTER_7_WATERSIDE_RENVALL,
					CHAPTER_8_ITS_A_TRAP, CHAPTER_9_EIRIKA_DISTANT_BLADE, CHAPTER_9_EPHRAIM_FORT_RIGWALD,
					CHAPTER_10_EIRIKA_REVOLT_AT_CARCINO, CHAPTER_10_EPHRAIM_TURNING_TRAITOR,
					CHAPTER_11_EIRIKA_CREEPING_DARKNESS, CHAPTER_11_EPHRAIM_PHANTOM_SHIP,
					CHAPTER_12_EIRIKA_VILLAGE_OF_SILENCE, CHAPTER_12_EPHRAIM_LANDING_AT_TAIZEL,
					CHAPTER_13_EIRIKA_HAMILL_CANYON, CHAPTER_13_EPHRAIM_FLUORSPARS_OATH,
					CHAPTER_14_EIRIKA_QUEEN_OF_WHITE_DUNES, CHAPTER_14_EPHRAIM_FATHER_AND_SON,
					CHAPTER_15_EIRIKA_SCORCHED_SAND, CHAPTER_15_EPHRAIM_SCORCHED_SAND,
					CHAPTER_16_EIRIKA_RULED_BY_MADNESS, CHAPTER_16_EPHRAIM_RULED_BY_MADNESS,
					CHAPTER_17_EIRIKA_RIVER_OF_REGRETS, CHAPTER_17_EPHRAIM_RIVER_OF_REGRETS,
					CHAPTER_18_EIRIKA_TWO_FACES_OF_EVIL, CHAPTER_18_EPHRAIM_TWO_FACES_OF_EVIL,
					CHAPTER_19_EIRIKA_LAST_HOPE, CHAPTER_19_EPHRAIM_LAST_HOPE, CHAPTER_20_EIRIKA_DARKLING_WOODS,
					CHAPTER_20_EPHRAIM_DARKLING_WOODS, FINAL_EIRIKA_SACRED_STONE_1, FINAL_EPHRAIM_SACRED_STONE_1,
					FINAL_EIRIKA_SACRED_STONE_2, FINAL_EPHRAIM_SACRED_STONE_2 };
		}

		public static ChapterMetadata[] additionalChapters() {
			return new ChapterMetadata[] { TOWER_OF_VALNI_1, TOWER_OF_VALNI_2, TOWER_OF_VALNI_3, TOWER_OF_VALNI_4,
					TOWER_OF_VALNI_5, TOWER_OF_VALNI_6, TOWER_OF_VALNI_7, TOWER_OF_VALNI_8, TOWER_OF_VALNI_9,
					TOWER_OF_VALNI_10,

					LAGDOU_RUINS_1, LAGDOU_RUINS_2, LAGDOU_RUINS_3, LAGDOU_RUINS_4, LAGDOU_RUINS_5, LAGDOU_RUINS_6,
					LAGDOU_RUINS_7, LAGDOU_RUINS_8, LAGDOU_RUINS_9, LAGDOU_RUINS_10,
		...
		public String getFriendlyName() {
			switch (this) {
			case PROLOGUE_THE_FALL_OF_RENAIS:
				return "Prologue: The Fall of Renais";
			case CHAPTER_1_ESCAPE:
				return "Chapter 1: Escape!";
			case CHAPTER_2_THE_PROTECTED:
				return "Chapter 2: The Protected";
			case CHAPTER_3_THE_BANDITS_OF_BORGO:
				return "Chapter 3: The Bandits of Borgo";
			case CHAPTER_4_ANCIENT_HORRORS:
				return "Chapter 4: Ancient Horrors";
			case CHAPTER_5_THE_EMPIRES_REACH:
				return "Chapter 5: The Empire's Reach";
			case CHAPTER_5X_UNBROKEN_HEART:
				return "Chatper 5x: Unbroken Heart";
			case CHAPTER_6_VICTIMS_OF_WAR:
				return "Chapter 6: Victims of War";
			case CHAPTER_7_WATERSIDE_RENVALL:
				return "Chapter 7: Waterside Renvall";
			case CHAPTER_8_ITS_A_TRAP:
				return "Chapter 8: It's a Trap!";
			case CHAPTER_9_EIRIKA_DISTANT_BLADE:
				return "Chapter 9 (Eirika): Distant Blade";
			case CHAPTER_9_EPHRAIM_FORT_RIGWALD:
				return "Chapter 9 (Ephraim): Fort Rigwald";
			case CHAPTER_10_EIRIKA_REVOLT_AT_CARCINO:
				return "Chapter 10 (Eirika): Revolt at Carcino";
			case CHAPTER_10_EPHRAIM_TURNING_TRAITOR:
				return "Chapter 10 (Ephraim): Turning Traitor";
			case CHAPTER_11_EIRIKA_CREEPING_DARKNESS:
				return "Chapter 11 (Eirika): Creeping Darkness";
			case CHAPTER_11_EPHRAIM_PHANTOM_SHIP:
				return "Chapter 11 (Ephraim): Phantom Ship";
			case CHAPTER_12_EIRIKA_VILLAGE_OF_SILENCE:
				return "Chapter 12 (Eirika): Village of Silence";
			case CHAPTER_12_EPHRAIM_LANDING_AT_TAIZEL:
				return "Chapter 12 (Ephraim): Landing at Taizel";
			case CHAPTER_13_EIRIKA_HAMILL_CANYON:
				return "Chapter 13 (Eirika): Hamill Canyon";
			case CHAPTER_13_EPHRAIM_FLUORSPARS_OATH:
				return "Chapter 13 (Ephraim): Fluorspar's Oath";
			case CHAPTER_14_EIRIKA_QUEEN_OF_WHITE_DUNES:
				return "Chapter 14 (Eirika): Queen of White Dunes";
			case CHAPTER_14_EPHRAIM_FATHER_AND_SON:
				return "Chapter 14 (Ephraim): Father and Son";
			case CHAPTER_15_EIRIKA_SCORCHED_SAND:
				return "Chapter 15 (Eirika): Scorched Sand";
			case CHAPTER_15_EPHRAIM_SCORCHED_SAND:
				return "Chapter 15 (Ephraim): Scorched Sand";
			case CHAPTER_16_EIRIKA_RULED_BY_MADNESS:
				return "Chapter 16 (Eirika): Ruled by Madness";
			case CHAPTER_16_EPHRAIM_RULED_BY_MADNESS:
				return "Chapter 16 (Ephraim): Ruled by Madness";
			case CHAPTER_17_EIRIKA_RIVER_OF_REGRETS:
				return "Chapter 17 (Eirika): River of Regrets";
			case CHAPTER_17_EPHRAIM_RIVER_OF_REGRETS:
				return "Chapter 17 (Ephraim): River of Regrets";
			case CHAPTER_18_EIRIKA_TWO_FACES_OF_EVIL:
				return "Chapter 18 (Eirika): Two Faces of Evil";
			case CHAPTER_18_EPHRAIM_TWO_FACES_OF_EVIL:
				return "Chapter 18 (Ephraim): Two Faces of Evil";
			case CHAPTER_19_EIRIKA_LAST_HOPE:
				return "Chapter 19 (Eirika): Last Hope";
			case CHAPTER_19_EPHRAIM_LAST_HOPE:
				return "Chapter 19 (Ephraim): Last Hope";
			case CHAPTER_20_EIRIKA_DARKLING_WOODS:
				return "Chapter 20 (Eirika): Darkling Woods";
			case CHAPTER_20_EPHRAIM_DARKLING_WOODS:
				return "Chapter 20 (Ephraim): Darkling Woods";
			case FINAL_EIRIKA_SACRED_STONE_1:
				return "Final (Eirika): Sacred Stone (Part 1)";
			case FINAL_EPHRAIM_SACRED_STONE_1:
				return "Final (Ephraim): Sacred Stone (Part 1)";
			case FINAL_EIRIKA_SACRED_STONE_2:
				return "Final (Eirika): Sacred Stone (Part 2)";
			case FINAL_EPHRAIM_SACRED_STONE_2:
				return "Final (Ephraim): Sacred Stone (Part 2)";
			default:
				return "?";
			}
		}
	...
	public enum ChapterPointer {
		PROLOGUE(0x07), CHAPTER_1(0x0A), CHAPTER_2(0x0D), CHAPTER_3(0x14), CHAPTER_4(0x17), CHAPTER_5(0x21),
		CHAPTER_5X(0x1E), CHAPTER_6(0x24), CHAPTER_7(0x27), CHAPTER_8(0x2A),

		CHAPTER_9_EIRIKA(0x2D), CHAPTER_10_EIRIKA(0x33), CHAPTER_11_EIRIKA(0xD1), CHAPTER_12_EIRIKA(0x37),
		CHAPTER_13_EIRIKA(0x3B), CHAPTER_14_EIRIKA(0x41), CHAPTER_15_EIRIKA(0x47), CHAPTER_16_EIRIKA(0x4B),
		CHAPTER_17_EIRIKA(0x4F), CHAPTER_18_EIRIKA(0x56), CHAPTER_19_EIRIKA(0x5A), CHAPTER_20_EIRIKA(0x5E),
		FINAL_1_EIRIKA(0x64), FINAL_2_EIRIKA(0x67),

		CHAPTER_9_EPHRAIM(0x6B), CHAPTER_10_EPHRAIM(0x71), CHAPTER_11_EPHRAIM(0xD5), CHAPTER_12_EPHRAIM(0x75),
		CHAPTER_13_EPHRAIM(0x78), CHAPTER_14_EPHRAIM(0x7F), CHAPTER_15_EPHRAIM(0x80), CHAPTER_16_EPHRAIM(0x81),
		CHAPTER_17_EPHRAIM(0x82), CHAPTER_18_EPHRAIM(0x83), CHAPTER_19_EPHRAIM(0x84), CHAPTER_20_EPHRAIM(0x85),
		...
		public static List<ChapterPointer> orderedChapters() {
			return new ArrayList<ChapterPointer>(Arrays.asList(PROLOGUE, CHAPTER_1, CHAPTER_2, CHAPTER_3, CHAPTER_4,
					CHAPTER_5, CHAPTER_5X, CHAPTER_6, CHAPTER_7, CHAPTER_8, CHAPTER_9_EIRIKA, CHAPTER_9_EPHRAIM,
					CHAPTER_10_EIRIKA, CHAPTER_10_EPHRAIM, CHAPTER_11_EIRIKA, CHAPTER_11_EPHRAIM, CHAPTER_12_EIRIKA,
					CHAPTER_12_EPHRAIM, CHAPTER_13_EIRIKA, CHAPTER_13_EPHRAIM, CHAPTER_14_EIRIKA, CHAPTER_14_EPHRAIM,
					CHAPTER_15_EIRIKA, CHAPTER_15_EPHRAIM, CHAPTER_16_EIRIKA, CHAPTER_16_EPHRAIM, CHAPTER_17_EIRIKA,
					CHAPTER_17_EPHRAIM, CHAPTER_18_EIRIKA, CHAPTER_18_EPHRAIM, CHAPTER_19_EIRIKA, CHAPTER_19_EPHRAIM,
					CHAPTER_20_EIRIKA, CHAPTER_20_EPHRAIM, FINAL_1_EIRIKA, FINAL_1_EPHRAIM, FINAL_2_EIRIKA,
					FINAL_2_EPHRAIM));
		}
		...
		public ChapterMetadata getMetadata() {
			switch (this) {
			case PROLOGUE:
				return ChapterMetadata.PROLOGUE_THE_FALL_OF_RENAIS;
			case CHAPTER_1:
				return ChapterMetadata.CHAPTER_1_ESCAPE;
			case CHAPTER_2:
				return ChapterMetadata.CHAPTER_2_THE_PROTECTED;
			case CHAPTER_3:
				return ChapterMetadata.CHAPTER_3_THE_BANDITS_OF_BORGO;
			case CHAPTER_4:
				return ChapterMetadata.CHAPTER_4_ANCIENT_HORRORS;
			case CHAPTER_5:
				return ChapterMetadata.CHAPTER_5_THE_EMPIRES_REACH;
			case CHAPTER_5X:
				return ChapterMetadata.CHAPTER_5X_UNBROKEN_HEART;
			case CHAPTER_6:
				return ChapterMetadata.CHAPTER_6_VICTIMS_OF_WAR;
			case CHAPTER_7:
				return ChapterMetadata.CHAPTER_7_WATERSIDE_RENVALL;
			case CHAPTER_8:
				return ChapterMetadata.CHAPTER_8_ITS_A_TRAP;
			case CHAPTER_9_EIRIKA:
				return ChapterMetadata.CHAPTER_9_EIRIKA_DISTANT_BLADE;
			case CHAPTER_9_EPHRAIM:
				return ChapterMetadata.CHAPTER_9_EPHRAIM_FORT_RIGWALD;
			case CHAPTER_10_EIRIKA:
				return ChapterMetadata.CHAPTER_10_EIRIKA_REVOLT_AT_CARCINO;
			case CHAPTER_10_EPHRAIM:
				return ChapterMetadata.CHAPTER_10_EPHRAIM_TURNING_TRAITOR;
			case CHAPTER_11_EIRIKA:
				return ChapterMetadata.CHAPTER_11_EIRIKA_CREEPING_DARKNESS;
			case CHAPTER_11_EPHRAIM:
				return ChapterMetadata.CHAPTER_11_EPHRAIM_PHANTOM_SHIP;
			case CHAPTER_12_EIRIKA:
				return ChapterMetadata.CHAPTER_12_EIRIKA_VILLAGE_OF_SILENCE;
			case CHAPTER_12_EPHRAIM:
				return ChapterMetadata.CHAPTER_12_EPHRAIM_LANDING_AT_TAIZEL;
			case CHAPTER_13_EIRIKA:
				return ChapterMetadata.CHAPTER_13_EIRIKA_HAMILL_CANYON;
			case CHAPTER_13_EPHRAIM:
				return ChapterMetadata.CHAPTER_13_EPHRAIM_FLUORSPARS_OATH;
			case CHAPTER_14_EIRIKA:
				return ChapterMetadata.CHAPTER_14_EIRIKA_QUEEN_OF_WHITE_DUNES;
			case CHAPTER_14_EPHRAIM:
				return ChapterMetadata.CHAPTER_14_EPHRAIM_FATHER_AND_SON;
			case CHAPTER_15_EIRIKA:
				return ChapterMetadata.CHAPTER_15_EIRIKA_SCORCHED_SAND;
			case CHAPTER_15_EPHRAIM:
				return ChapterMetadata.CHAPTER_15_EPHRAIM_SCORCHED_SAND;
			case CHAPTER_16_EIRIKA:
				return ChapterMetadata.CHAPTER_16_EIRIKA_RULED_BY_MADNESS;
			case CHAPTER_16_EPHRAIM:
				return ChapterMetadata.CHAPTER_16_EPHRAIM_RULED_BY_MADNESS;
			case CHAPTER_17_EIRIKA:
				return ChapterMetadata.CHAPTER_17_EIRIKA_RIVER_OF_REGRETS;
			case CHAPTER_17_EPHRAIM:
				return ChapterMetadata.CHAPTER_17_EPHRAIM_RIVER_OF_REGRETS;
			case CHAPTER_18_EIRIKA:
				return ChapterMetadata.CHAPTER_18_EIRIKA_TWO_FACES_OF_EVIL;
			case CHAPTER_18_EPHRAIM:
				return ChapterMetadata.CHAPTER_18_EPHRAIM_TWO_FACES_OF_EVIL;
			case CHAPTER_19_EIRIKA:
				return ChapterMetadata.CHAPTER_19_EIRIKA_LAST_HOPE;
			case CHAPTER_19_EPHRAIM:
				return ChapterMetadata.CHAPTER_19_EPHRAIM_LAST_HOPE;
			case CHAPTER_20_EIRIKA:
				return ChapterMetadata.CHAPTER_20_EIRIKA_DARKLING_WOODS;
			case CHAPTER_20_EPHRAIM:
				return ChapterMetadata.CHAPTER_20_EPHRAIM_DARKLING_WOODS;
			case FINAL_1_EIRIKA:
				return ChapterMetadata.FINAL_EIRIKA_SACRED_STONE_1;
			case FINAL_1_EPHRAIM:
				return ChapterMetadata.FINAL_EPHRAIM_SACRED_STONE_1;
			case FINAL_2_EIRIKA:
				return ChapterMetadata.FINAL_EIRIKA_SACRED_STONE_2;
			case FINAL_2_EPHRAIM:
				return ChapterMetadata.FINAL_EPHRAIM_SACRED_STONE_2;
			default:
				return null;
			}
		}
		...
		public CharacterClass[] blacklistedClasses() {
			switch (this) {
			case CHAPTER_5X:
				return new CharacterClass[] { CharacterClass.WYVERN_RIDER, CharacterClass.WYVERN_RIDER_F }; // The
																											// cutscene
																											// after the
																											// chapter
																											// has
																											...
																											// same.
			case CHAPTER_6:
				return new CharacterClass[] { CharacterClass.BAEL }; // Give the player some chance of getting here in
																		// time.
			default:
		...
		public CharacterNudge[] nudgesRequired() {
			switch (this) {
			case CHAPTER_9_EIRIKA:
				return new CharacterNudge[] { new CharacterNudge(Character.TANA.ID, 0, 2, 0, 5) }; // Tana flies
																									// onscreen for a
																									// scene. This
																									// allows us to keep
																									// her class from
		...
		public static ChapterPointer chapterForWorldMapEventOffset(long offset) {
			if (offset == 0xA39768L) {
				return PROLOGUE;
			} else if (offset == 0xA39D0CL) {
				return CHAPTER_1;
			} else if (offset == 0xA39D44L) {
				return CHAPTER_2;
			} else if (offset == 0xA39F20L) {
				return CHAPTER_3;
			} else if (offset == 0xA3A0BCL) {
				return CHAPTER_4;
			} else if (offset == 0xA3A1ECL) {
				return CHAPTER_5;
			} else if (offset == 0xA3C890L) {
				return CHAPTER_5X;
			} else if (offset == 0xA3A4D8L) {
				return CHAPTER_6;
			} else if (offset == 0xA3A5C4L) {
				return CHAPTER_7;
			} else if (offset == 0xA3A6B0L) {
				return CHAPTER_8;
			} else if (offset == 0xA3A730L) {
				return CHAPTER_9_EIRIKA;
			} else if (offset == 0xA3AE58L) {
				return CHAPTER_9_EPHRAIM;
			} else if (offset == 0xA3A990L) {
				return CHAPTER_10_EIRIKA;
			} else if (offset == 0xA3B08CL) {
				return CHAPTER_10_EPHRAIM;
			} else if (offset == 0xA3C8A8L) {
				return CHAPTER_11_EIRIKA;
			} else if (offset == 0xA3C9D0L) {
				return CHAPTER_11_EPHRAIM;
			} else if (offset == 0xA3AB50L) {
				return CHAPTER_12_EIRIKA;
			} else if (offset == 0xA3B1D8L) {
				return CHAPTER_12_EPHRAIM;
			} else if (offset == 0xA3AB6CL) {
				return CHAPTER_13_EIRIKA;
			} else if (offset == 0xA3B1F4L) {
				return CHAPTER_13_EPHRAIM;
			} else if (offset == 0xA3ACB0L) {
				return CHAPTER_14_EIRIKA;
			} else if (offset == 0xA3B2DCL) {
				return CHAPTER_14_EPHRAIM;
			} else if (offset == 0xA3B528L) {
				return CHAPTER_15_EIRIKA;
			} else if (offset == 0xA3BD74L) {
				return CHAPTER_15_EPHRAIM;
			} else if (offset == 0xA3B594L) {
				return CHAPTER_16_EIRIKA;
			} else if (offset == 0xA3BF28L) {
				return CHAPTER_16_EPHRAIM;
			} else if (offset == 0xA3B738L) {
				return CHAPTER_17_EIRIKA;
			} else if (offset == 0xA3C0B4L) {
				return CHAPTER_17_EPHRAIM;
			} else if (offset == 0xA3B8E8L) {
				return CHAPTER_18_EIRIKA;
			} else if (offset == 0xA3C260L) {
				return CHAPTER_18_EPHRAIM;
			} else if (offset == 0xA3BA64L) {
				return CHAPTER_19_EIRIKA;
			} else if (offset == 0xA3C3DCL) {
				return CHAPTER_19_EPHRAIM;
			} else if (offset == 0xA3BB74L) {
				return CHAPTER_20_EIRIKA;
			} else if (offset == 0xA3C4ECL) {
				return CHAPTER_20_EPHRAIM;
			} else if (offset == 0xA3BD58L) {
				return FINAL_1_EIRIKA;
			} else if (offset == 0xA3C6D0L) {
				return FINAL_1_EPHRAIM;
			} else if (offset == 0xA3C898L) {
				return FINAL_2_EIRIKA;
			} else if (offset == 0xA3C8A0L) {
				return FINAL_2_EPHRAIM;
			} else {
				// There's some events not tied to any specific chapter, so we can ignore those
				// for now.
				return null;
			}
		}
	...
	public enum PromotionItem implements GBAFEPromotionItem {
		...
		// Remember that the actual address of the class IDs starts at byte 4 after the
		// jump.
		// The class IDs are 00 terminated.
		HERO_CREST(0x01), KNIGHT_CREST(0x02), ORION_BOLT(0x03), ELYSIAN_WHIP(0x04), GUIDING_RING(0x05),
		MASTER_SEAL(0x25),

		LUNAR_BRACE(0x6C), SOLAR_BRACE(0x6E), HEAVEN_SEAL(0x70), OCEAN_SEAL(0x7C);
		;
	...
	public enum Palette {
		...
		BONEWALKER(0x00, Character.NONE.ID, CharacterClass.BONEWALKER.ID, 0xDD1290), // Bonewalkers with Bows use the
																						// same palette
		...
		ELDER_BAEL(0x00, Character.NONE.ID, CharacterClass.ELDER_BAEL.ID, 0xDE4F08), // ELDER_BAEL_2 is probably the
																						// same.
		...
		static {
			...
			defaultPaletteForClass.put(CharacterClass.SUPER_TRAINEE.ID, TRAINEE_ROSS.info); // Trainees all have the
																							// same sprite, so they
			...
			defaultPaletteForClass.put(CharacterClass.ARCHER.ID, ARCHER_NEIMI.info); // Archer is the same palette
																						// format as Archer_F
		...
		private Palette(int paletteID, int charID, int classID, long offset) {
			...
			if (charClass != null) {
				switch (charClass) {
				case EIRIKA_LORD:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 6, 7, 8 }, new int[] { 9, 10, 11 },
							new int[] { 12, 13, 14 });
					break;
				case EIRIKA_MASTER_LORD:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 5, 6, 7 }, new int[] { 9, 10, 11 },
							new int[] { 12, 13, 14 });
					break;
				case EPHRAIM_LORD:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 6, 7, 8 }, new int[] {},
							new int[] { 9, 10 }, new int[] { 12, 13, 14 });
					break;
				case EPHRAIM_MASTER_LORD:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 5, 6, 7 }, new int[] {},
							new int[] { 9, 10 }, new int[] {});
					break;
				case TRAINEE:
				case TRAINEE_2:
				case SUPER_TRAINEE:
				...
				case PUPIL_2:
				case SUPER_PUPIL:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 5, 6, 7 },
							new int[] { 12, 13, 14 }, new int[] { 9, 10, 11 });
					break;
				case MANAKETE_F:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 8, 9, 10 }, new int[] { 11, 12 },
							new int[] { 13, 14 });
					break;
				case REVENANT:
				case ENTOMBED:
					this.info = new PaletteInfo(classID, Character.NONE.ID, offset, new int[] { 6, 7 },
							new int[] { 12, 13, 14 }, new int[] {}); // These guys actually have hair. The second color
																		// is the remnants of their pants.
					break;
				case BONEWALKER:
				case BONEWALKER_BOW:
				case WIGHT:
				case WIGHT_BOW:
					this.info = new PaletteInfo(classID, Character.NONE.ID, offset, new int[] {},
							new int[] { 8, 9, 10 }, new int[] { 2, 3, 4 }); // No hair. Primary is their loincloth.
																			// Secondary is their breastplate.
					break;
				case BAEL:
					this.info = new PaletteInfo(classID, Character.NONE.ID, offset, new int[] { 5, 4, 6, 3, 7 },
							new int[] {}, new int[] {}); // They have two hair colors, but in the case of the Bael,
															// they're the same color, so we're keeping it that way.
					break;
				case ELDER_BAEL:
				case ELDER_BAEL_2:
					this.info = new PaletteInfo(classID, Character.NONE.ID, offset, new int[] { 5, 6, 7 },
							new int[] { 4, 3 }, new int[] {}); // Unlike Baels, Elder Baels gain a different color
																// streak through their "hair". That's reflected here.
					break;
				case CYCLOPS:
				case CYCLOPS_2:
					this.info = new PaletteInfo(classID, Character.NONE.ID, offset, new int[] {},
							new int[] { 6, 7, 2, 3, 4, 5 }, new int[] { 13, 14 }); // No hair again, but lots of armor
																					// colors. Secondary is the color of
																					// their loincloth.
					break;
				case MAUTHE_DOOG:
					this.info = new PaletteInfo(classID, Character.NONE.ID, offset, new int[] { 9, 10, 11 },
							new int[] { 12, 13, 14 }, new int[] {});
					break;
				case GWYLLGI:
					this.info = new PaletteInfo(classID, Character.NONE.ID, offset, new int[] { 9, 10, 11 },
							new int[] { 12, 13, 14 }, new int[] { 6, 7, 8 }); // Gwyllgis get a tail color in addition
																				// to what they had as Mauth Doogs.
					break;
				case TARVOS:
				case MAELDUIN:
					this.info = new PaletteInfo(classID, Character.NONE.ID, offset, new int[] { 6, 7 },
							new int[] { 2, 3, 4, 5 }, new int[] {}); // They have a body color, but since they share the
																		// same as Maelduins, we want to have some
																		// difference between the two.
					break;
				case MOGALL:
				case ARCH_MOGALL:
					this.info = new PaletteInfo(classID, Character.NONE.ID, offset, new int[] { 12, 13, 14 },
							new int[] { 4, 5, 6 }, new int[] {}); // "Hair" is the tentacles. "Armor" is the membrane.
					break;
				case GORGON:
					this.info = new PaletteInfo(classID, Character.NONE.ID, offset, new int[] { 5, 6, 7 },
							new int[] { 12, 13, 14 }, new int[] { 2, 3, 4 });
					break;
				case GARGOYLE:
					this.info = new PaletteInfo(classID, Character.NONE.ID, offset, new int[] { 2, 3, 4 }, new int[] {},
							new int[] {}); // "Hair" is their horns and claws. Let's not touch anything else for now.
											// They'll get their colors when promoted
					break;
				case DEATHGOYLE:
					this.info = new PaletteInfo(classID, Character.NONE.ID, offset, new int[] { 2, 3, 4 },
							new int[] { 11, 12, 13, 14 }, new int[] { 9, 10 }); // Now they get a non-gray body.
					break;
				case MERCENARY:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 6, 7, 12 }, new int[] { 9, 3, 14 },
							new int[] {});
					break;
				case HERO:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 5, 6, 7 },
							new int[] { 11, 12, 13 }, new int[] {});
					break;
				case MYRMIDON:
				case MYRMIDON_F:
				case SWORDMASTER:
				...
				case CLERIC:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 5, 6, 7 },
							new int[] { 11, 12, 13, 14 }, new int[] {});
					break;
				case FIGHTER:
				case BRIGAND:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 6, 7 }, new int[] { 12, 13, 14 },
							new int[] {});
					break;
				case WARRIOR:
				case BERSERKER:
					this.info = new PaletteInfo(classID, charID, offset, new int[] {}, new int[] { 12, 13, 14 },
							new int[] {});
					break;
				case RANGER:
				case RANGER_F:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 6, 7 }, new int[] { 13, 5 },
							new int[] { 8, 9, 10, 11 });
					break;
				case CAVALIER:
				case CAVALIER_F:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 6, 7 },
							new int[] { 8, 3, 9, 5, 10, 11 }, new int[] {});
					break;
				case PALADIN:
					this.info = new PaletteInfo(classID, charID, offset, new int[] {}, new int[] { 8, 9, 10, 11 },
							new int[] { 6, 7 }, new int[] { 5, 3, 4 }); // Secondary is shield (which is blended with
																		// white). Tertiary is mane + shield crest.
					break;
				case PALADIN_F:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 6, 7 }, new int[] { 8, 9, 10 },
							new int[] { 5, 3, 4 }); // Hair also affects shield. Secondary is mane + shield crest.
					break;
				case KNIGHT:
					this.info = new PaletteInfo(classID, charID, offset, new int[] {}, new int[] { 6, 4, 5, 3, 2, 1 },
							new int[] {});
					break;
				case KNIGHT_F:
					this.info = new PaletteInfo(classID, charID, offset, new int[] {}, new int[] { 6, 4, 2, 1 },
							new int[] {});
					break;
				case GENERAL:
				case GENERAL_F:
					this.info = new PaletteInfo(classID, charID, offset, new int[] {}, new int[] { 11, 12, 13, 14 },
							new int[] { 4, 5, 7 });
					break;
				case GREAT_KNIGHT:
				case GREAT_KNIGHT_F:
					...
					break;
				case WYVERN_RIDER:
					this.info = new PaletteInfo(classID, charID, offset, new int[] {}, new int[] { 3, 2 },
							new int[] { 10, 11, 12, 13 }, new int[] { 9 });
					break;
				case WYVERN_LORD:
					this.info = new PaletteInfo(classID, charID, offset, new int[] {}, new int[] { 7, 8 },
							new int[] { 10, 11, 12, 13 }, new int[] { 9 });
					break;
				case WYVERN_KNIGHT:
				case WYVERN_KNIGHT_F:
					this.info = new PaletteInfo(classID, charID, offset, new int[] {}, new int[] { 9, 8, 7 },
							new int[] { 10, 11, 12, 13 }, new int[] {});
					break;
				case PEGASUS_KNIGHT:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 7, 6 }, new int[] { 9, 10 },
							new int[] {});
					break;
				case FALCON_KNIGHT:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 7, 6 }, new int[] { 9, 10, 14 },
							new int[] {});
					break;
				case MAGE:
				case MAGE_F:
				...
				case SAGE:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 5, 6, 7 },
							new int[] { 11, 12, 13, 14 }, new int[] { 8, 9, 10 });
					break;
				case SAGE_F:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 5, 6, 7 },
							new int[] { 12, 13, 14 }, new int[] { 11, 8, 9, 10 });
					break;
				case MAGE_KNIGHT:
				case MAGE_KNIGHT_F:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 6, 7 }, new int[] { 10, 11 },
							new int[] { 8, 9 }, new int[] { 12, 13, 14 }); // Primary is cape, secondary is shirt,
																			// tertiary is horse armor.
					break;
				case SHAMAN:
				case DRUID:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 8, 9, 10 },
							new int[] { 11, 12, 13, 14 }, new int[] {});
					break;
				case SUMMONER:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 7, 8 }, new int[] { 12, 13, 14 },
							new int[] { 9, 10, 11 });
					break;
				case BISHOP:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 5, 6 }, new int[] { 8, 13, 14 },
							new int[] { 11, 12 });
					break;
				case BISHOP_F:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 5, 6 },
							new int[] { 11, 12, 13, 14 }, new int[] {});
					break;
				case TROUBADOUR:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 6, 7 }, new int[] { 8, 9, 10, 11 },
							new int[] {});
					break;
				case VALKYRIE:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 6, 7 },
							new int[] { 8, 9, 10, 11, 14 }, new int[] {});
					break;
				case THIEF:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 5, 6, 7 }, new int[] { 12, 11, 4 },
							new int[] { 13, 14 });
					break;
				case ASSASSIN:
				case ASSASSIN_F:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 6, 7 }, new int[] { 5, 10 },
							new int[] { 12, 13, 14 });
					break;
				case ROGUE:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 8, 9 }, new int[] { 12, 13, 14 },
							new int[] { 5, 6, 7 });
					break;
				case DANCER:
					this.info = new PaletteInfo(classID, charID, offset, new int[] { 5, 6, 7 },
							new int[] { 12, 13, 14 }, new int[] { 8, 9, 10 });
					break;
				case PIRATE:
					this.info = new PaletteInfo(classID, charID, offset, new int[] {}, new int[] { 11, 12, 13, 14 },
							new int[] {});
		...
		public static int maxPaletteIndex() {
			return 0xF0; // There's space for this many, but they're all 0s. Seems like they could be
							// used. It actually goes to FF, but we'll leave some space.
		}
		...
		public static PaletteColor[] supplementaryHairColorForCharacter(int characterID) {
			...
			switch (character) {
			case SETH:
				return new PaletteColor[] { new PaletteColor(189, 16, 8), new PaletteColor(132, 0, 0),
						new PaletteColor(99, 16, 24) };
			case GILLIAM:
				return new PaletteColor[] { new PaletteColor(132, 132, 107), new PaletteColor(99, 99, 74),
						new PaletteColor(74, 66, 66) };
			case CORMAG:
			case GLEN:
				return new PaletteColor[] { new PaletteColor(255, 255, 189), new PaletteColor(222, 222, 99),
						new PaletteColor(173, 173, 49), new PaletteColor(115, 115, 49) };
			case DOZLA:
				return new PaletteColor[] { new PaletteColor(90, 148, 74), new PaletteColor(49, 99, 41),
						new PaletteColor(57, 66, 41) };
			case DUESSEL:
				return new PaletteColor[] { new PaletteColor(222, 214, 214), new PaletteColor(198, 173, 181),
						new PaletteColor(156, 123, 156), new PaletteColor(107, 82, 107), new PaletteColor(74, 66, 74) };
			case BREGUET:
				return new PaletteColor[] { new PaletteColor(123, 132, 189), new PaletteColor(82, 90, 132),
						new PaletteColor(66, 57, 82) };
			case SAAR:
				return new PaletteColor[] { new PaletteColor(198, 181, 148), new PaletteColor(148, 132, 123),
						new PaletteColor(90, 66, 74) };
			case AIAS:
				return new PaletteColor[] { new PaletteColor(214, 206, 107), new PaletteColor(173, 165, 49),
						new PaletteColor(107, 99, 16) };
			case GHEB:
				return new PaletteColor[] { new PaletteColor(181, 115, 24), new PaletteColor(140, 82, 8),
						new PaletteColor(99, 57, 24) };
			case VALTER:
				return new PaletteColor[] { new PaletteColor(123, 173, 189), new PaletteColor(82, 115, 115),
						new PaletteColor(57, 74, 74) };
			case ORSON:
				return new PaletteColor[] { new PaletteColor(189, 123, 74), new PaletteColor(148, 99, 57),
						new PaletteColor(107, 66, 57) };
			default:
				return null;
			}
		}
	...
	public Set<GBAFEClass> classesThatLoseToClass(GBAFEClass sourceClass, GBAFEClass winningClass,
		...
		if (excludeLords == null) {
			excludeLords = false;
		}
		Boolean excludeThieves = options.get(GBAFEClassProvider.optionKeyExcludeThieves);
		if (excludeThieves == null) {
			excludeThieves = false;
		}
		return new HashSet<GBAFEClass>(
				CharacterClass.classesThatLoseToClass(CharacterClass.valueOf(sourceClass.getID()),
						CharacterClass.valueOf(winningClass.getID()), excludeLords, excludeThieves));
	}

	public Set<GBAFEClass> targetClassesForRandomization(GBAFEClass sourceClass, boolean isForEnemy,
			Map<String, Boolean> options) {
		Boolean excludeLords = options.get(GBAFEClassProvider.optionKeyExcludeLords);
		if (excludeLords == null) {
			excludeLords = false;
		...
		if (restrictGender == null) {
			restrictGender = false;
		}

		return new HashSet<GBAFEClass>(
				CharacterClass.targetClassesForRandomization(CharacterClass.valueOf(sourceClass.getID()), isForEnemy,
						excludeSource, excludeLords, excludeThieves, excludeSpecial, separateMonsters, requireAttack,
						requiresRange, requiresMelee, applyRestrictions, restrictGender));
	}

	public GBAFEClass correspondingMaleClass(GBAFEClass charClass) {
		switch ((FE8Data.CharacterClass) charClass) {
		case RECRUIT:
			return FE8Data.CharacterClass.PUPIL;
		case EIRIKA_LORD:
			return FE8Data.CharacterClass.EPHRAIM_LORD;
		case CAVALIER_F:
			return FE8Data.CharacterClass.CAVALIER;
		case KNIGHT_F:
			return FE8Data.CharacterClass.KNIGHT;
		case MYRMIDON_F:
			return FE8Data.CharacterClass.MYRMIDON;
		case ARCHER_F:
			return FE8Data.CharacterClass.ARCHER;
		case MAGE_F:
			return FE8Data.CharacterClass.MAGE;
		case CLERIC:
			return FE8Data.CharacterClass.PRIEST;
		case RECRUIT_2:
			return FE8Data.CharacterClass.TRAINEE_2;
		case EIRIKA_MASTER_LORD:
			return FE8Data.CharacterClass.EPHRAIM_MASTER_LORD;
		case PALADIN_F:
			return FE8Data.CharacterClass.PALADIN;
		case GENERAL_F:
			return FE8Data.CharacterClass.GENERAL;
		case SWORDMASTER_F:
			return FE8Data.CharacterClass.SWORDMASTER;
		case ASSASSIN_F:
			return FE8Data.CharacterClass.ASSASSIN;
		case SNIPER_F:
			return FE8Data.CharacterClass.SNIPER;
		case RANGER_F:
			return FE8Data.CharacterClass.RANGER;
		case WYVERN_KNIGHT_F:
			return FE8Data.CharacterClass.WYVERN_KNIGHT;
		case SAGE_F:
			return FE8Data.CharacterClass.SAGE;
		case MAGE_KNIGHT_F:
			return FE8Data.CharacterClass.MAGE_KNIGHT;
		case BISHOP_F:
			return FE8Data.CharacterClass.BISHOP;
		case GREAT_KNIGHT_F:
			return FE8Data.CharacterClass.GREAT_KNIGHT;
		case SUPER_RECRUIT:
			return FE8Data.CharacterClass.SUPER_TRAINEE;
		default:
			return charClass;
		}
	}
	...
	public GBAFEClass correspondingFemaleClass(GBAFEClass charClass) {
		...
		case TRAINEE:
		case PUPIL:
			return FE8Data.CharacterClass.RECRUIT;
		case EPHRAIM_LORD:
			return FE8Data.CharacterClass.EIRIKA_LORD;
		case CAVALIER:
			return FE8Data.CharacterClass.CAVALIER_F;
		case KNIGHT:
			return FE8Data.CharacterClass.KNIGHT_F;
		case MYRMIDON:
			return FE8Data.CharacterClass.MYRMIDON_F;
		case ARCHER:
			return FE8Data.CharacterClass.ARCHER_F;
		case MAGE:
			return FE8Data.CharacterClass.MAGE_F;
		case PRIEST:
			return FE8Data.CharacterClass.CLERIC;
		case TRAINEE_2:
		case PUPIL_2:
			return FE8Data.CharacterClass.RECRUIT_2;
		case EPHRAIM_MASTER_LORD:
			return FE8Data.CharacterClass.EIRIKA_MASTER_LORD;
		case PALADIN:
			return FE8Data.CharacterClass.PALADIN_F;
		case GENERAL:
			return FE8Data.CharacterClass.GENERAL_F;
		case SWORDMASTER:
			return FE8Data.CharacterClass.SWORDMASTER_F;
		case ASSASSIN:
			return FE8Data.CharacterClass.ASSASSIN_F;
		case SNIPER:
			return FE8Data.CharacterClass.SNIPER_F;
		case RANGER:
			return FE8Data.CharacterClass.RANGER_F;
		case WYVERN_KNIGHT:
			return FE8Data.CharacterClass.WYVERN_KNIGHT_F;
		case SAGE:
			return FE8Data.CharacterClass.SAGE_F;
		case MAGE_KNIGHT:
			return FE8Data.CharacterClass.MAGE_KNIGHT_F;
		case BISHOP:
			return FE8Data.CharacterClass.BISHOP_F;
		case GREAT_KNIGHT:
			return FE8Data.CharacterClass.GREAT_KNIGHT_F;
		case SUPER_TRAINEE:
		case SUPER_PUPIL:
			return FE8Data.CharacterClass.SUPER_RECRUIT;
		default:
			return charClass;
		}
	}
	...
	public Set<GBAFEItem> weaponsWithStatBoosts() {
		return new HashSet<GBAFEItem>(Arrays.asList(Item.EXCALIBUR, Item.GLEIPNIR, Item.SIEGLINDE, Item.IVALDI,
				Item.VIDOFNIR, Item.AUDHULMA, Item.SIEGMUND, Item.GARM, Item.NIDHOGG));
	}

	public Set<GBAFEItem> weaponsWithEffectiveness() {
		return new HashSet<GBAFEItem>(Arrays.asList(Item.RAPIER, Item.ARMORSLAYER, Item.WYRMSLAYER, Item.ZANBATO,
				Item.SWORDSLAYER, Item.IRON_BOW, Item.SHADOWKILLER, Item.BEACON_BOW));
	}

	public Set<GBAFEItem> weaponsOfTypeUpToRank(WeaponType type, WeaponRank rank, Boolean rangedOnly,
			Boolean requiresMelee) {
	...
	public Set<GBAFEItem> weaponsOfTypeAndEqualRank(WeaponType type, WeaponRank rank, Boolean rangedOnly,
			Boolean requiresMelee, Boolean allowLower) {
		if (type == Item.FE8WeaponType.DARK.toGeneralType() && rank == Item.FE8WeaponRank.E.toGeneralRank()) {
			rank = WeaponRank.D;
		}
	...
	public Set<GBAFEItem> comparableWeaponsForClass(int classID, WeaponRanks ranks, GBAFEItemData originalItem,
			boolean strict) {
		...
		itemsUsableByClass.removeIf(
				weapon -> (weapon.getType() == WeaponType.SWORD && ranks.swordRank.isLowerThan(weapon.getRank())));
		itemsUsableByClass.removeIf(
				weapon -> (weapon.getType() == WeaponType.LANCE && ranks.lanceRank.isLowerThan(weapon.getRank())));
		itemsUsableByClass.removeIf(
				weapon -> (weapon.getType() == WeaponType.AXE && ranks.axeRank.isLowerThan(weapon.getRank())));
		itemsUsableByClass.removeIf(
				weapon -> (weapon.getType() == WeaponType.BOW && ranks.bowRank.isLowerThan(weapon.getRank())));
		itemsUsableByClass.removeIf(
				weapon -> (weapon.getType() == WeaponType.ANIMA && ranks.animaRank.isLowerThan(weapon.getRank())));
		itemsUsableByClass.removeIf(
				weapon -> (weapon.getType() == WeaponType.LIGHT && ranks.lightRank.isLowerThan(weapon.getRank())));
		itemsUsableByClass.removeIf(
				weapon -> (weapon.getType() == WeaponType.DARK && ranks.darkRank.isLowerThan(weapon.getRank())));
		itemsUsableByClass.removeIf(
				weapon -> (weapon.getType() == WeaponType.STAFF && ranks.staffRank.isLowerThan(weapon.getRank())));

		Set<GBAFEItem> usableSet = new HashSet<GBAFEItem>(itemsUsableByClass);

		final WeaponRank effectiveRank = rank;
		itemsUsableByClass.removeIf(weapon -> (effectiveRank.isLowerThan(weapon.getRank()))); // Remove anything that's
																								// higher the weapon
																								// passed in.
		...
		if (strict) {
			...
			} else if (Item.effectiveSet.contains(item)
					&& !Collections.disjoint(Item.effectiveSet, itemsUsableByClass)) {
			...
			} else if (Item.interestingSet.contains(item)
					&& !Collections.disjoint(Item.interestingSet, itemsUsableByClass)) {
	...
	public String statBoostStringForWeapon(GBAFEItem weapon) {
		if (weapon == Item.EXCALIBUR || weapon == Item.GARM) {
			return "+5 Speed";
		}
		if (weapon == Item.GLEIPNIR) {
			return "+5 Skill";
		}
		if (weapon == Item.SIEGLINDE || weapon == Item.SIEGMUND) {
			return "+5 Strength";
		}
		if (weapon == Item.IVALDI || weapon == Item.VIDOFNIR) {
			return "+5 Defense";
		}
		if (weapon == Item.AUDHULMA) {
			return "+5 Resistance";
		}
		if (weapon == Item.NIDHOGG) {
			return "+5 Luck";
		}
	...
	public String effectivenessStringForWeapon(GBAFEItem weapon, Boolean shortString) {
		if (weapon == Item.RAPIER) {
			return shortString ? "Eff. Infantry" : "Effective against infantry";
		}
		if (weapon == Item.ARMORSLAYER) {
			return shortString ? "Eff. Knights" : "Effective against knights";
		}
		if (weapon == Item.WYRMSLAYER) {
			return shortString ? "Eff. Dragons" : "Effective against dragons";
		}
		if (weapon == Item.ZANBATO) {
			return shortString ? "Eff. Cavalry" : "Effective against cavalry";
		}
		if (weapon == Item.SWORDSLAYER) {
			return shortString ? "Eff. Swordfighters" : "Effective against swordfighters";
		}
		if (weapon == Item.IRON_BOW) {
			return shortString ? "Eff. Fliers" : "Effective against fliers";
		}
		// Group Beacon Bow with Shadowkiller. It should be obvious that all bows are
		// effective against fliers by default.
		if (weapon == Item.SHADOWKILLER || weapon == Item.BEACON_BOW) {
			return shortString ? "Eff. Monsters" : "Effective against monsters";
		}
	...
	public List<GBAFEClass> knightCavEffectivenessClasses() {
		return new ArrayList<GBAFEClass>(Arrays.asList(CharacterClass.CAVALIER, CharacterClass.CAVALIER_F,
				CharacterClass.PALADIN, CharacterClass.PALADIN_F, CharacterClass.GREAT_KNIGHT,
				CharacterClass.GREAT_KNIGHT_F, CharacterClass.KNIGHT, CharacterClass.KNIGHT_F, CharacterClass.GENERAL,
				CharacterClass.GENERAL_F, CharacterClass.RANGER, CharacterClass.RANGER_F, CharacterClass.TROUBADOUR,
				CharacterClass.VALKYRIE, CharacterClass.MAGE_KNIGHT, CharacterClass.MAGE_KNIGHT_F,
				CharacterClass.EIRIKA_MASTER_LORD, CharacterClass.EPHRAIM_MASTER_LORD, CharacterClass.TARVOS,
				CharacterClass.MAELDUIN, CharacterClass.NONE, CharacterClass.NONE, CharacterClass.NONE // One
																										// placeholder
																										// for Eirika,
																										// one
																										// placeholder
	...
	public List<GBAFEClass> knightEffectivenessClasses() {
		return new ArrayList<GBAFEClass>(Arrays.asList(CharacterClass.GREAT_KNIGHT, CharacterClass.GREAT_KNIGHT_F,
				CharacterClass.KNIGHT, CharacterClass.KNIGHT_F, CharacterClass.GENERAL, CharacterClass.GENERAL_F,
				CharacterClass.NONE, CharacterClass.NONE, CharacterClass.NONE));
	}

	public List<GBAFEClass> cavalryEffectivenessClasses() {
		return new ArrayList<GBAFEClass>(
				Arrays.asList(CharacterClass.CAVALIER, CharacterClass.CAVALIER_F, CharacterClass.PALADIN,
						CharacterClass.PALADIN_F, CharacterClass.GREAT_KNIGHT, CharacterClass.GREAT_KNIGHT_F,
						CharacterClass.RANGER, CharacterClass.RANGER_F, CharacterClass.TROUBADOUR,
						CharacterClass.VALKYRIE, CharacterClass.MAGE_KNIGHT, CharacterClass.MAGE_KNIGHT_F,
						CharacterClass.EIRIKA_MASTER_LORD, CharacterClass.EPHRAIM_MASTER_LORD, CharacterClass.TARVOS,
						CharacterClass.MAELDUIN, CharacterClass.NONE, CharacterClass.NONE, CharacterClass.NONE));
	}

	public List<GBAFEClass> dragonEffectivenessClasses() {
		return new ArrayList<GBAFEClass>(Arrays.asList(CharacterClass.DRACOZOMBIE, CharacterClass.MANAKETE_2,
				CharacterClass.MANAKETE_F, CharacterClass.WYVERN_RIDER, CharacterClass.WYVERN_RIDER_F,
				CharacterClass.WYVERN_KNIGHT, CharacterClass.WYVERN_KNIGHT_F, CharacterClass.WYVERN_LORD,
				CharacterClass.WYVERN_LORD_F, CharacterClass.NONE, CharacterClass.NONE, CharacterClass.NONE));
	}

	public List<GBAFEClass> flierEffectivenessClasses() {
		return new ArrayList<GBAFEClass>(
				Arrays.asList(CharacterClass.PEGASUS_KNIGHT, CharacterClass.FALCON_KNIGHT, CharacterClass.WYVERN_KNIGHT,
						CharacterClass.WYVERN_KNIGHT_F, CharacterClass.WYVERN_RIDER, CharacterClass.WYVERN_RIDER_F,
						CharacterClass.WYVERN_LORD, CharacterClass.WYVERN_LORD_F, CharacterClass.GARGOYLE,
						CharacterClass.DEATHGOYLE, CharacterClass.MANAKETE_2, CharacterClass.MANAKETE_F,
						CharacterClass.DRACOZOMBIE, CharacterClass.NONE, CharacterClass.NONE, CharacterClass.NONE));
	}

	public List<GBAFEClass> myrmidonEffectivenessClasses() {
		return new ArrayList<GBAFEClass>(Arrays.asList(CharacterClass.MYRMIDON, CharacterClass.MYRMIDON_F,
				CharacterClass.SWORDMASTER, CharacterClass.SWORDMASTER_F, CharacterClass.MERCENARY,
				CharacterClass.MERCENARY_F, CharacterClass.HERO, CharacterClass.HERO_F, CharacterClass.NONE,
				CharacterClass.NONE, CharacterClass.NONE));
	}

	public List<GBAFEClass> monsterEffectivenessClasses() {
		return new ArrayList<GBAFEClass>(Arrays.asList(CharacterClass.REVENANT, CharacterClass.ENTOMBED,
				CharacterClass.BONEWALKER, CharacterClass.BONEWALKER_BOW, CharacterClass.WIGHT,
				CharacterClass.WIGHT_BOW, CharacterClass.BAEL, CharacterClass.ELDER_BAEL, CharacterClass.ELDER_BAEL_2,
				CharacterClass.CYCLOPS, CharacterClass.CYCLOPS_2, CharacterClass.MAUTHE_DOOG, CharacterClass.GWYLLGI,
				CharacterClass.TARVOS, CharacterClass.MAELDUIN, CharacterClass.MOGALL, CharacterClass.ARCH_MOGALL,
				CharacterClass.GORGON, CharacterClass.GORGON_EGG,
				// CharacterClass.GORGON_EGG_2,
				CharacterClass.GARGOYLE, CharacterClass.DEATHGOYLE, CharacterClass.DRACOZOMBIE,
				CharacterClass.DEMON_KING, CharacterClass.GHOST_FIGHTER, CharacterClass.NONE, CharacterClass.NONE,
				CharacterClass.NONE));
	}

	public AdditionalData effectivenessPointerType(long effectivenessPtr) {
		if (effectivenessPtr == 0x8ADEC2L) {
			return AdditionalData.KNIGHTCAV_EFFECT;
		}
		if (effectivenessPtr == 0x8ADEBBL) {
			return AdditionalData.KNIGHT_EFFECT;
		}
		if (effectivenessPtr == 0x8ADF13L) {
			return AdditionalData.DRAGON_EFFECT;
		}
		if (effectivenessPtr == 0x8ADEE0L) {
			return AdditionalData.CAVALRY_EFFECT;
		}
		if (effectivenessPtr == 0x8ADED7L) {
			return AdditionalData.MYRMIDON_EFFECT;
		}
		if (effectivenessPtr == 0x8ADF2AL) {
			return AdditionalData.FLIERS_EFFECT;
		}
		if (effectivenessPtr == 0x8ADF39L) {
			return AdditionalData.MONSTER_EFFECT;
		}
//		if (effectivenessPtr == 0x8ADEF1L) { return AdditionalData.MONSTER_EFFECT; } // Monsters + Fliers
	...
	public List<GBAFEClass> additionalClassesForPromotionItem(GBAFEPromotionItem promotionItem,
		...
		if (promotionItem == PromotionItem.KNIGHT_CREST) {
			return new ArrayList<GBAFEClass>(Arrays.asList(CharacterClass.EIRIKA_LORD, CharacterClass.EPHRAIM_LORD,
					CharacterClass.SOLDIER, CharacterClass.BAEL, CharacterClass.TARVOS));
		}
		if (promotionItem == PromotionItem.HERO_CREST) {
			return new ArrayList<GBAFEClass>(
					Arrays.asList(CharacterClass.REVENANT, CharacterClass.BONEWALKER, CharacterClass.MAUTHE_DOOG));
		}
		...
		if (promotionItem == PromotionItem.MASTER_SEAL) {
			return new ArrayList<GBAFEClass>(Arrays.asList(CharacterClass.EPHRAIM_LORD, CharacterClass.EIRIKA_LORD,
					CharacterClass.SOLDIER, CharacterClass.BAEL, CharacterClass.TARVOS, CharacterClass.REVENANT,
					CharacterClass.BONEWALKER, CharacterClass.MAUTHE_DOOG, CharacterClass.GARGOYLE,
					CharacterClass.BONEWALKER_BOW, CharacterClass.MOGALL));
		}
