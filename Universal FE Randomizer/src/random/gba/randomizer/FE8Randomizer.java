...
public class FE8Randomizer extends AbstractGBARandomizer {
    ...
    public void runDataloaders() {
        ...
        updateProgress(0.05);
        mapSprites = new MapSpriteManager(FEBase.GameType.FE8, sourceFileHandler);

        updateStatusString("Loading Promotion Data...");
        updateProgress(0.06);
        promotionData = new PromotionDataLoader(sourceFileHandler);
        ...
        updateProgress(0.20);
        chapterData = new ChapterLoader(FEBase.GameType.FE8, sourceFileHandler, allOptions);
        ...
        updateProgress(0.40);
        fe8_paletteMapper = paletteData.setupFE8SpecialManagers(sourceFileHandler, promotionData);
